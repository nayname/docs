...
<Info>
  **100% EVM Compatible:** All critical Ethereum behaviors are preserved. Deploy your contracts, use MetaMask, connect with Web3.js/Ethers - everything works as expected.
</Info>
...
<Card title="Full Ethereum RPC Support" icon="code" href="/v0.4.x/api-reference/ethereum-json-rpc/methods">
