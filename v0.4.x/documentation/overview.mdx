...
<CardGroup cols={2}>
  <Card title="Full Ethereum Compatibility" icon="ethereum" href="/v0.4.x/documentation/evm-compatibility/overview">
    Deploy existing Solidity contracts, use familiar tools like MetaMask, Hardhat, and Foundry
  </Card>
  <Card title="Cosmos Native Features" icon="link" href="/v0.4.x/documentation/smart-contracts/precompiles/overview">
    Access staking, governance, IBC, and other Cosmos SDK modules directly from smart contracts
  </Card>
  <Card title="Instant Finality" icon="zap" href="/v0.4.x/documentation/concepts/transactions">
    1-2 second block times with instant finality via Tendermint consensus
  </Card>
  <Card title="Cross-Chain Ready" icon="globe" href="/v0.4.x/documentation/concepts/ibc">
