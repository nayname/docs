...
* **WERC20 Precompile:** Implements single token representation for native tokens. See [WERC20 docs](/docs/documentation/smart-contracts/precompiles/werc20).
* **ERC20 Module:** Manages token pairs and infrastructure. See [ERC20 module docs](/docs/documentation/cosmos-sdk/modules/erc20).
