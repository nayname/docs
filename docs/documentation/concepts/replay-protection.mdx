...
As documented in the [Chain ID](/docs/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/docs/documentation/concepts/chain-id)
- [Transaction Types](/docs/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/docs/documentation/cosmos-sdk/modules/vm#parameters)