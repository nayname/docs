...
- [Precompiles](/docs/documentation/smart-contracts/precompiles) - Native chain implementations exposed as smart contracts
- [Gas and Fees](/docs/documentation/concepts/gas-and-fees) - Understanding gas consumption for predeployed contracts
- [Chain ID](/docs/documentation/concepts/chain-id) - How chain identity affects contract addresses
- [Implementation Guide](/docs/documentation/smart-contracts/predeployed-contracts/overview) - Technical details for deploying and managing preinstalled contracts