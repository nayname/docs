...
<Tabs>
  <Tab title="Conitions for Pronotion Met">
    <Card title="Promote to Public Mempool" icon="package-check" color="#10b981">
  ...
  <Tab title="Condition for Promotion Unmet">
    <Card title="Keep in Local Queue" icon="clipboard-clock" color="#ef4444">
