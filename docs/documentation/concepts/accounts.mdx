...
For more information on Ethereum accounts head over to the [x/evm module](/documentation/cosmos-sdk/modules/vm#concepts).
...
To retrieve the Ethereum hex address using Web3, use the JSON-RPC [`eth_accounts`](/api-reference/ethereum-json-rpc/methods#eth-accounts) or [`personal_listAccounts`](/api-reference/ethereum-json-rpc/methods#personal-listAccounts) endpoints:
