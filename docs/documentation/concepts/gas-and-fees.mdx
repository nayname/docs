...
2. Nodes receive transactions for a subsequent block and gossip these transactions to peers
   * These can be sorted and prioritized by the included fee price (using EIP-1559 fee priority mechanics for EVM transactions - [code snippet](https://github.com/cosmos/evm/blob/57ed355c985d9f3116aba6aabfa2ee0f3f38e966/app/ante/eth.go)), to be included in the next block

3. Nodes run `BeginBlock` for the subsequent block

   * The FeeMarket module calculates the `BaseFee` ([code snippet](https://github.com/cosmos/evm/blob/89fdd1984826ea524cb9b8feb089a99b6cfe8ace/x/feemarket/keeper/abci.go)) to be applied for this block using the total `GasWanted` from the previous block.
...
+++ [https://github.com/cosmos/evm/blob/098da6d0cc0e0c4cefbddf632df1057383973e4a/x/evm/keeper/state\_transition.go](https://github.com/cosmos/evm/blob/098da6d0cc0e0c4cefbddf632df1057383973e4a/x/evm/keeper/state_transition.go)
...
+++ [https://github.com/cosmos/evm/blob/098da6d0cc0e0c4cefbddf632df1057383973e4a/x/evm/keeper/grpc\_query.go](https://github.com/cosmos/evm/blob/098da6d0cc0e0c4cefbddf632df1057383973e4a/x/evm/keeper/grpc_query.go)
