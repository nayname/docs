...
<CardGroup cols={2}>
  <Card title="Foundry Guide" href="/docs/evm/developers/tooling-and-resources/foundry" icon="hammer">
    Fast, efficient smart contract development and testing
  </Card>
  <Card title="Hardhat Guide" href="/docs/evm/developers/tooling-and-resources/hardhat" icon="wrench">
