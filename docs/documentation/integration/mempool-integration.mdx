...
1. **EVM Module Integration**: Complete the [EVM module integration](/docs/documentation/integration/add-evm-module) first
...
- [EVM Module Integration](/docs/documentation/integration/add-evm-module) - Prerequisites for mempool integration
