...
1. **EVM Module Integration**: Complete the [EVM module integration](/documentation/integration/evm-module-integration) first
...
- [Mempool Concepts](/documentation/concepts/mempool) - Understanding mempool behavior and design
- [EVM Module Integration](/documentation/integration/evm-module-integration) - Prerequisites for mempool integration
- [JSON-RPC Methods](/api-reference/ethereum-json-rpc/methods#txpool-methods) - Mempool query methods