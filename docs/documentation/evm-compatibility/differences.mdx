...
description: "Full Ethereum compatibility with enhanced Cosmos features"
mode: "wide"
...
Cosmos EVM provides **full Ethereum compatibility** on Cosmos chains. Your existing Ethereum dApps, tools, and workflows work seamlessly while gaining the benefits of Cosmos consensus and interoperability.
...
<Card title="Full Ethereum RPC Support" icon="code" href="/docs/api-reference/ethereum-json-rpc/methods">
...
<Card title="EIP Compatibility Matrix" icon="list-check" href="/docs/documentation/evm-compatibility/eip-reference">
...
<CardGroup cols={2}>
  ...
  <Card title="Concepts" icon="book" href="/docs/documentation/concepts">
    Deep dive into architecture and design
  </Card>
  <Card title="GitHub Repository" icon="github" href="https://github.com/cosmos/evm">
    Source code and issue tracker
  </Card>
  <Card title="Precompiles Docs" icon="code" href="/docs/documentation/smart-contracts/precompiles">
