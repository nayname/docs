...
<Tip>
For a detailed breakdown on **Ethereum Improvement Proposal** (EIP) support and functional comparisons, see the [EIP reference](/docs/documentation/evm-compatibility/eip-reference) table.
</Tip>
