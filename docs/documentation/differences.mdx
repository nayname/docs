...
4. **Experimental pending state** - [Two-tiered mempool](/docs/documentation/concepts/mempool) (local queue + public pool) handles nonce gaps - **WARNING: This is experimental and not recommended for production**
...
### Verified Precompile Addresses

| Precompile | Address | Status |
|------------|---------|--------|
| **P256 Verify** | `0x0000000000000000000000000000000000000100` | Implemented |
| **Bech32** | `0x0000000000000000000000000000000000000400` | Implemented |
| **Staking** | `0x0000000000000000000000000000000000000800` | Implemented |
| **Distribution** | `0x0000000000000000000000000000000000000801` | Implemented |
| **ICS20** | `0x0000000000000000000000000000000000000802` | Implemented |
| **Bank** | `0x0000000000000000000000000000000000000804` | Implemented |
| **Governance** | `0x0000000000000000000000000000000000000805` | Implemented |
| **Slashing** | `0x0000000000000000000000000000000000000806` | Implemented |
...
### Key RPC Differences
- **Mining methods**: Not implemented in eth namespace (Tendermint consensus replaces mining)
- **Miner namespace**: Limited implementation - only `setEtherbase` and `setGasPrice` available
- **Uncle methods**: Always return 0/null since no uncle blocks exist in Tendermint
...
- **eth_getWork**: Not implemented (mining not applicable)
