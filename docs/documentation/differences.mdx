...
|--------|----------|--------|
| `eth_createAccessList` | EIP-2930 | Fully implemented |
| `eth_pendingTransactions` | Transaction Pool | Fully implemented |
...
| `admin_*` | Node administration | Fully implemented with all standard admin methods |
