...
4. **Experimental pending state** - [Two-tiered mempool](/documentation/concepts/mempool) (local queue + public pool) handles nonce gaps
...
8. **Token precision** - Native tokens use 18 decimals via [x/precisebank module](/documentation/concepts/single-token-representation)
9. **EIP compatibility** - Most Core EIPs supported with some consensus-related exceptions ([see full matrix](/documentation/eip-support))
...
<Note>
  For detailed migration steps, see [Migration Guide v0.3 to v0.4](/documentation/integration/migration-v0.3-to-v0.4)
</Note>
