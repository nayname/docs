...
The WERC20 precompile provides a standard ERC20 interface to native Cosmos tokens through Cosmos EVM's **[Single Token Representation](/documentation/concepts/single-token-representation)** architecture.
...
<Note>
For a comprehensive understanding of how single token representation works and its benefits over traditional wrapping, see the [Single Token Representation](/documentation/concepts/single-token-representation) documentation.
</Note>
