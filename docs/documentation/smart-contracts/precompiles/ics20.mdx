...
<Info>
For detailed callback implementation, see [IBC Module](/docs/documentation/cosmos-sdk/modules/ibc) and [Callbacks Interface](/docs/documentation/smart-contracts/precompiles/callbacks).
</Info>
