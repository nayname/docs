...
Cosmos EVM supports the full [Ethereum JSON-RPC](/api-reference/ethereum-json-rpc) API, enabling you to:
...
* Use [block explorers](/documentation/getting-started/tooling-and-resources/block-explorers) to debug and monitor your contracts
...
These precompiles open up functionality that would be impossible or prohibitively expensive with regular smart contracts. [View all available precompiles →](/documentation/smart-contracts/precompiles)
...
* **Documentation:** [Cosmos EVM Precompiles](/documentation/smart-contracts/precompiles) | [Tooling Guide](/documentation/getting-started/tooling-and-resources/overview)
