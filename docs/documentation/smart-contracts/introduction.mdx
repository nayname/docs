...
Cosmos EVM supports the full [Ethereum JSON-RPC](/develop/api/ethereum-json-rpc) API, enabling you to:
...
* Use [block explorers](/develop/block-explorers) to debug and monitor your contracts
...
These precompiles open up functionality that would be impossible or prohibitively expensive with regular smart contracts. [View all available precompiles →](/develop/smart-contracts/list-precompiles)
...
* **Documentation:** [Cosmos EVM Precompiles](/develop/smart-contracts/list-precompiles) | [Tooling Guide](/develop/tooling)
