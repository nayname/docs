...
* Exposing a fully compatible Web3 [JSON-RPC](/develop/api/ethereum-json-rpc/methods) layer for interacting with existing Ethereum clients and tooling (Metamask, Remix, etc).
...
Cosmos EVM enables the full composability and modularity of the [Cosmos SDK](https://docs.cosmos.network/). It includes standard modules from the Cosmos SDK that work side to side with EVM-specific modules. Check out the [list of modules](/protocol/modules) to get an overview of what each module is responsible for.
...
Most components are implemented in the [VM module](/protocol/modules/vm) To achieve a seamless developer UX, however, some of the components are implemented outside of the module.
...
* [Accounts](/protocol/concepts/accounts)
* [Gas and Fees](/protocol/concepts/gas-and-fees)
* [Token representations](/protocol/concepts/tokens)
* [Transactions](/protocol/concepts/transactions)
