...
* Exposing a fully compatible Web3 [JSON-RPC](/docs/api-reference/ethereum-json-rpc/methods) layer for interacting with existing Ethereum clients and tooling (Metamask, Remix, etc).
...
* [JSON-RPC](/docs/api-reference/ethereum-json-rpc) client for interacting with the EVM

Most components are implemented in the [VM module](/docs/documentation/cosmos-sdk/modules/vm) To achieve a seamless developer UX, however, some of the components are implemented outside of the module.
...
* [Accounts](/docs/documentation/concepts/accounts)
* [Gas and Fees](/docs/documentation/concepts/gas-and-fees)
* [Token representations](/docs/documentation/concepts/tokens)
* [Transactions](/docs/documentation/concepts/transactions)
