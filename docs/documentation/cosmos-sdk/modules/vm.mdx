...
<Note>
  For conceptual understanding of EVM architecture and design, see [EVM Architecture](/docs/documentation/concepts/overview).
</Note>
...
- [EVM Architecture](/docs/documentation/concepts/overview) - Conceptual overview
