...
<Note>
  For conceptual understanding of EVM architecture and design, see [EVM Architecture](/docs/documentation/concepts/evm-architecture).
</Note>
...
- [EVM Architecture](/docs/documentation/concepts/evm-architecture) - Conceptual overview
- [Fee Market Module](/docs/documentation/cosmos-sdk/modules/feemarket) - EIP-1559 implementation
- [ERC20 Module](/docs/documentation/cosmos-sdk/modules/erc20) - Token conversions