...
### Token Pair[​](#token-pair "Direct link to Token Pair")
...
### Token Pair Registration[​](#token-pair-registration "Direct link to Token Pair Registration")
...
#### Registration of a Cosmos Coin[​](#registration-of-a-cosmos-coin "Direct link to Registration of a Cosmos Coin")

A native Cosmos Coin corresponds to an `sdk.Coin` that is native to the bank module. It can be either the native staking/gas denomination (e.g. ATOM, etc) or an IBC fungible token voucher (i.e. with denom format of `ibc/{hash}`).
...
#### Registration of an ERC20 token[​](#registration-of-an-erc20-token "Direct link to Registration of an ERC20 token")
...
#### Token details and metadata[​](#token-details-and-metadata "Direct link to Token details and metadata")
...
#### Coin Metadata to ERC20 details[​](#coin-metadata-to-erc20-details "Direct link to Coin Metadata to ERC20 details")
...
#### IBC voucher Metadata to ERC20 details[​](#ibc-voucher-metadata-to-erc20-details "Direct link to IBC voucher Metadata to ERC20 details")
...
#### ERC20 details to Coin Metadata[​](#erc20-details-to-coin-metadata "Direct link to ERC20 details to Coin Metadata")
...
### Token Pair Modifiers[​](#token-pair-modifiers "Direct link to Token Pair Modifiers")
...
### Malicious Contracts[​](#malicious-contracts "Direct link to Malicious Contracts")
...
#### Token Origin[​](#token-origin "Direct link to Token Origin")
...
#### Token Pair by ERC20 and by Denom[​](#token-pair-by-erc20-and-by-denom "Direct link to Token Pair by ERC20 and by Denom")
...
### Token Pair Registration[​](#token-pair-registration-1 "Direct link to Token Pair Registration")
...
#### 1. Register Coin[​](#1-register-coin "Direct link to 1. Register Coin")
...
3. If Cosmos coin or IBC voucher exist on the bank module supply, create the [ERC20 token contract](https://github.com/cosmos/evm/blob/main/contracts/solidity/ERC20MinterBurnerDecimals.sol) on the EVM based on the ERC20Mintable ([ERC20Mintable by openzeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC20)) interface

   * Initial supply: 0
   * Token details (Name, Symbol, Decimals, etc) are derived from the bank module `Metadata` field on the proposal content.

#### 2. Register ERC20[​](#2-register-erc20 "Direct link to 2. Register ERC20")
...
### Token Pair Conversion[​](#token-pair-conversion "Direct link to Token Pair Conversion")
...
#### 1. Registered Coin[​](#1-registered-coin "Direct link to 1. Registered Coin")
...
##### 1.1 Coin to ERC20[​](#11-coin-to-erc20 "Direct link to 1.1 Coin to ERC20")
...
##### 1.2 ERC20 to Coin[​](#12-erc20-to-coin "Direct link to 1.2 ERC20 to Coin")
...
#### 2. Registered ERC20[​](#2-registered-erc20 "Direct link to 2. Registered ERC20")
...
##### Invariants[​](#invariants-1 "Direct link to Invariants")
...
##### 2.1 ERC20 to Coin[​](#21-erc20-to-coin "Direct link to 2.1 ERC20 to Coin")
...
##### 2.2 Coin to ERC20[​](#22-coin-to-erc20 "Direct link to 2.2 Coin to ERC20")
...
### `RegisterCoinProposal`[​](#registercoinproposal "Direct link to registercoinproposal")
...
### `RegisterERC20Proposal`[​](#registererc20proposal "Direct link to registererc20proposal")
...
### `MsgConvertCoin`[​](#msgconvertcoin "Direct link to msgconvertcoin")
...
### `MsgConvertERC20`[​](#msgconverterc20 "Direct link to msgconverterc20")
...
### `ToggleTokenConversionProposal`[​](#toggletokenconversionproposal "Direct link to toggletokenconversionproposal")
...
### EVM Hooks[​](#evm-hooks "Direct link to EVM Hooks")
...
#### Registered Coin: ERC20 to Coin[​](#registered-coin-erc20-to-coin "Direct link to Registered Coin: ERC20 to Coin")
...
### Register Coin Proposal[​](#register-coin-proposal "Direct link to Register Coin Proposal")
...
### Register ERC20 Proposal[​](#register-erc20-proposal "Direct link to Register ERC20 Proposal")
...
### Toggle Token Conversion[​](#toggle-token-conversion "Direct link to Toggle Token Conversion")
...
### Convert Coin[​](#convert-coin "Direct link to Convert Coin")
...
### Convert ERC20[​](#convert-erc20 "Direct link to Convert ERC20")
...
### Enable ERC20[​](#enable-erc20 "Direct link to Enable ERC20")
...
### Enable EVM Hook[​](#enable-evm-hook "Direct link to Enable EVM Hook")
...
Find below a list of `appd` commands added with the `x/erc20` module. You can obtain the full list by using the `appd -h` command. A CLI command can look like this:
...
For more information on how to draft a proposal, refer to the [Cosmos SDK governance documentation](https://docs.cosmos.network/v0.46/modules/gov/).
