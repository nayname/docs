...
<Note>
  For conceptual understanding of Single Token Representation v2, see [Single Token Representation](/docs/documentation/concepts/single-token-representation).
</Note>
...
- [Single Token Representation](/docs/documentation/concepts/single-token-representation) - Conceptual overview
- [VM Module](/docs/documentation/cosmos-sdk/modules/vm) - EVM execution environment
