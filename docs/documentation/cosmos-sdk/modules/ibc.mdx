...
<Info>
Smart contracts can initiate IBC transfers using the [ICS20 Precompile](/docs/documentation/smart-contracts/precompiles/ics20), which provides the `transfer` function with memo field support for callbacks.
</Info>
...
- [IBC Overview](/docs/documentation/concepts/ibc) - IBC concepts and fundamentals
- [ICS20 Precompile](/docs/documentation/smart-contracts/precompiles/ics20) - Cross-chain token transfers
- [Callbacks Interface](/docs/documentation/smart-contracts/precompiles/callbacks) - Smart contract callback interface
