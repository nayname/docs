...
The `epochs` module defines on-chain timers that execute at fixed time intervals. Other Cosmos modules can then register logic to be executed at the timer ticks. We refer to the period in between two timer ticks as an "epoch".
...
#### EpochInfo[​](#epochinfo "Direct link to EpochInfo")
...
### Epochs Keeper[​](#epochs-keeper "Direct link to Epochs Keeper")
...
### Hooks Implementation[​](#hooks-implementation "Direct link to Hooks Implementation")
...
### Recieving Hooks[​](#recieving-hooks "Direct link to Recieving Hooks")
...
### Block-Time Drifts[​](#block-time-drifts "Direct link to Block-Time Drifts")
