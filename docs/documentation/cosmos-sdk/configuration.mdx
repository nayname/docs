---
title: EVM Configuration Reference
description: EVM-specific configuration parameters for Cosmos EVM nodes
mode: "wide"
---

Configure EVM-specific settings in `~/.evmd/config/app.toml`. This reference covers parameters unique to the EVM implementation.
