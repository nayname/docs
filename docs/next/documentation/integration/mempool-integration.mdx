...
This guide provides step-by-step instructions for integrating the EVM mempool into your Cosmos EVM chain. For conceptual information about mempool design and architecture, see the [Mempool Concepts](/docs/next/documentation/concepts/mempool) page.
...
<Warning>
**v0.5.0 Breaking Change:** The global mempool registry (`SetGlobalEVMMempool`) has been removed. Mempool is now passed directly to the JSON-RPC server during initialization.
</Warning>
...
### Full Configuration Options (v0.5.0+)
...
Use the [txpool RPC methods](/docs/next/api-reference/ethereum-json-rpc/methods#txpool-methods) to monitor mempool state:
...
- [Mempool Concepts](/docs/next/documentation/concepts/mempool) - Understanding mempool behavior and design
- [EVM Module Integration](/docs/next/documentation/integration/evm-module-integration) - Prerequisites for mempool integration
- [JSON-RPC Methods](/docs/next/api-reference/ethereum-json-rpc/methods#txpool-methods) - Mempool query methods