...
<Note>
For a comprehensive understanding of how single token representation works and its benefits over traditional wrapping, see the [Single Token Representation](/docs/next/documentation/concepts/single-token-representation) documentation.
</Note>
