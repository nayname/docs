...
Cosmos EVM supports the full [Ethereum JSON-RPC](/docs/next/api-reference/ethereum-json-rpc) API, enabling you to:
...
* Use [block explorers](/docs/next/documentation/getting-started/tooling-and-resources/block-explorers) to debug and monitor your contracts
...
These precompiles open up functionality that would be impossible or prohibitively expensive with regular smart contracts. [View all available precompiles →](/docs/next/documentation/smart-contracts/precompiles)
...
* **Documentation:** [Cosmos EVM Precompiles](/docs/next/documentation/smart-contracts/precompiles) | [Tooling Guide](/docs/next/documentation/getting-started/tooling-and-resources/overview)
