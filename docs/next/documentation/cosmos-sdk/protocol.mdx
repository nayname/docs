...
* Exposing a fully compatible Web3 [JSON-RPC](/docs/next/api-reference/ethereum-json-rpc/methods) layer for interacting with existing Ethereum clients and tooling (Metamask, Remix, etc).
...
* [JSON-RPC](/docs/next/api-reference/ethereum-json-rpc) client for interacting with the EVM

Most components are implemented in the [VM module](/docs/next/documentation/cosmos-sdk/modules/vm) To achieve a seamless developer UX, however, some of the components are implemented outside of the module.
...
* [Accounts](/docs/next/documentation/concepts/accounts)
* [Gas and Fees](/docs/next/documentation/concepts/gas-and-fees)
* [Token representations](/docs/next/documentation/concepts/tokens)
* [Transactions](/docs/next/documentation/concepts/transactions)
