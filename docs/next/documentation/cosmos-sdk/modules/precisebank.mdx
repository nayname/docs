...
<Note>
  For conceptual understanding of precision handling and mathematical proofs, see [Precision Handling](/docs/next/documentation/concepts/precision-handling).
</Note>
...
- [Precision Handling](/docs/next/documentation/concepts/precision-handling) - Mathematical foundation
- [VM Module](/docs/next/documentation/cosmos-sdk/modules/vm) - EVM integration
