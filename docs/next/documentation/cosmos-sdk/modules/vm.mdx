...
<Note>
  For conceptual understanding of EVM architecture and design, see [EVM Architecture](/docs/next/documentation/concepts/overview).
</Note>
...
- [EVM Architecture](/docs/next/documentation/concepts/overview) - Conceptual overview
- [Fee Market Module](/docs/next/documentation/cosmos-sdk/modules/feemarket) - EIP-1559 implementation
- [ERC20 Module](/docs/next/documentation/cosmos-sdk/modules/erc20) - Token conversions