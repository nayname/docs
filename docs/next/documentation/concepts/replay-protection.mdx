...
As documented in the [Chain ID](/docs/next/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/docs/next/documentation/concepts/chain-id)
- [Transaction Types](/docs/next/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/docs/next/documentation/cosmos-sdk/modules/vm#parameters)