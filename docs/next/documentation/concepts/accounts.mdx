...
**EIP-7702 Support**: Cosmos EVM supports [EIP-7702 code delegation](/docs/next/documentation/evm-compatibility/eip-7702), allowing EOAs to temporarily delegate code execution to smart contracts through the `SetCodeHash` functionality.

For more information on Ethereum accounts head over to the [x/vm module](/docs/next/documentation/cosmos-sdk/modules/vm).
...
<Note>
For JSON-RPC methods, see [`eth_accounts`](/docs/next/api-reference/ethereum-json-rpc/methods#eth-accounts) and [`personal_listAccounts`](/docs/next/api-reference/ethereum-json-rpc/methods#personal-listAccounts) documentation.
</Note>
