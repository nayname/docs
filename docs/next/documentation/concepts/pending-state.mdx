...
* [Mempool Architecture](/docs/next/documentation/concepts/mempool)
...
See the [JSON-RPC Methods](/docs/next/api-reference/ethereum-json-rpc/methods#txpool-methods) documentation for complete details.
...
* [`eth_getBalance`](/docs/next/api-reference/ethereum-json-rpc/methods#eth_getbalance) - Get balance considering pending transactions
* [`eth_getTransactionCount`](/docs/next/api-reference/ethereum-json-rpc/methods#eth_gettransactioncount) - Get next nonce considering pending transactions
* [`eth_getBlockTransactionCountByNumber`](/docs/next/api-reference/ethereum-json-rpc/methods#eth_getblocktransactioncountbynumber) - Count pending transactions
* [`eth_getBlockByNumber`](/docs/next/api-reference/ethereum-json-rpc/methods#eth_getblockbynumber) - Get pending block information
* [`eth_getTransactionByHash`](/docs/next/api-reference/ethereum-json-rpc/methods#eth_gettransactionbyhash) - Retrieve pending transactions
* [`eth_getTransactionByBlockNumberAndIndex`](/docs/next/api-reference/ethereum-json-rpc/methods#eth_gettransactionbyblockhashandindex) - Access specific pending transactions
* [`eth_sendTransaction`](/docs/next/api-reference/ethereum-json-rpc/methods#eth_sendtransaction) - Submit new transactions

Additionally, the `txpool_*` namespace provides specialized methods for mempool inspection:
* [`txpool_status`](/docs/next/api-reference/ethereum-json-rpc/methods#txpool_status) - Get pool statistics
* [`txpool_content`](/docs/next/api-reference/ethereum-json-rpc/methods#txpool_content) - View all pool transactions
* [`txpool_contentFrom`](/docs/next/api-reference/ethereum-json-rpc/methods#txpool_contentfrom) - Filter by address
* [`txpool_inspect`](/docs/next/api-reference/ethereum-json-rpc/methods#txpool_inspect) - Human-readable summaries
...
- See [Mempool Architecture](/docs/next/documentation/concepts/mempool#architecture) for the two-tier system design
- Review [Transaction Flow](/docs/next/documentation/concepts/mempool#transaction-flow) for state transitions
- Check [Integration Guide](/docs/next/documentation/integration/mempool-integration) for implementation details