...
- **[Migration Guide v0.4.x → v0.5.0](../documentation/integration/migration-v0.4-to-v0.5):** Complete migration instructions with parameter changes
...
- **[Node Configuration Guide](../documentation/getting-started/node-configuration):** Complete parameter reference
