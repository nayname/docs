...
| [`personal_sendTransaction`](#personal_sendtransaction)                               | Personal  | ✅          | ❌     | Requires config    |
| [`personal_sign`](#personal_sign)                                                     | Personal  | ✅          | ❌     |                    |
| [`personal_ecRecover`](#personal_ecrecover)                                           | Personal  | ✅          | ❌     | Requires config    |
...
| [`txpool_content`](#txpool_content)                                                   | TxPool    | ✅          | ✅     | Requires config    |
| [`txpool_inspect`](#txpool_inspect)                                                   | TxPool    | ✅          | ✅     | Requires config    |
| [`txpool_status`](#txpool_status)                                                     | TxPool    | ✅          | ✅     | Requires config    |
