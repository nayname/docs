...
| [`eth_getFilterChanges`](#eth_getfilterchanges)                                       | Eth       | ❌          | ❌     | Filter not found   |
| [`eth_getFilterLogs`](#eth_getfilterlogs)                                             | Eth       | ❌          | ❌     | Filter not found   |
...
| [`eth_getProof`](#eth_getproof)                                                       | Eth       | ⚠️         | ✅     | Height > 2 required|
| `eth_feeHistory`                                                                      | Eth       | ❌          | ❌     | Not implemented    |
| `eth_maxPriorityFeePerGas`                                                            | Eth       | ✅          | ✅     | EIP-1559           |
| `eth_chainId`                                                                         | Eth       | ✅          | ✅     |                    |
| `eth_getBlockReceipts`                                                                | Eth       | ✅          | ✅     |                    |
| `eth_resend`                                                                          | Eth       | ❌          | ❌     | Not implemented    |
| `eth_pendingTransactions`                                                             | Eth       | ❌          | ❌     | Not implemented    |
| `eth_createAccessList`                                                                | Eth       | ❌          | ❌     | EIP-2930           |
| [`eth_subscribe`](#eth_subscribe)                                                     | Websocket | ⚠️         | ✅     | syncing not impl.  |
...
| [`personal_lockAccount`](#personal_lockaccount)                                       | Personal  | ❌          | ❌     | Not supported      |
| [`personal_newAccount`](#personal_newaccount)                                         | Personal  | ✅          | ❌     |                    |
| [`personal_unlockAccount`](#personal_unlockaccount)                                   | Personal  | ⚠️         | ❌     | Always returns false|
| [`personal_sendTransaction`](#personal_sendtransaction)                               | Personal  | ❌          | ❌     | Not implemented    |
| [`personal_sign`](#personal_sign)                                                     | Personal  | ✅          | ❌     |                    |
| [`personal_ecRecover`](#personal_ecrecover)                                           | Personal  | ❌          | ❌     | Not implemented    |
...
| [`debug_traceTransaction`](#debug_tracetransaction)                                   | Debug     | ⚠️         | ❌     | Height issues      |
...
| `debug_getRawBlock`                                                                   | Debug     | ❌          | ❌     | Not implemented    |
| `debug_getRawHeader`                                                                  | Debug     | ❌          | ❌     | Not implemented    |
| `debug_getRawReceipts`                                                                | Debug     | ❌          | ❌     | Not implemented    |
| `debug_getRawTransaction`                                                             | Debug     | ❌          | ❌     | Not implemented    |
| `debug_printBlock`                                                                    | Debug     | ❌          | ❌     | Not implemented    |
...
| [`miner_getHashrate`](#miner_gethashrate)                                             | Miner     | ❌          | ❌     | Not implemented    |
| [`miner_setExtra`](#miner_setextra)                                                   | Miner     | ❌          | ❌     | Not implemented    |
| [`miner_setGasPrice`](#miner_setgasprice)                                             | Miner     | ❌          | ❌     | Not implemented    |
| [`miner_start`](#miner_start)                                                         | Miner     | ❌          | ❌     | Not implemented    |
| [`miner_stop`](#miner_stop)                                                           | Miner     | ❌          | ❌     | Not implemented    |
| [`miner_setGasLimit`](#miner_setgaslimit)                                             | Miner     | ❌          | ❌     | Not implemented    |
| [`miner_setEtherbase`](#miner_setetherbase)                                           | Miner     | ❌          | ❌     | Not implemented    |
...
| `eth_signTypedData`                                                                   | Eth       | ⚠️         | ❌     | EIP-712 partial    |
| `eth_fillTransaction`                                                                 | Eth       | ❌          | ❌     | Not implemented    |
...
* Mining methods (`miner_*`) are not implemented
...
* `miner_*` methods - All mining-related functionality
