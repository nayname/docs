...
<Info>
  ...
  * `clique_*` methods - Proof of Authority consensus
  ...
  For more details on how Cosmos EVM differs from standard Ethereum implementations, see [Differences from Standard EVMs](/documentation/differences).
</Info>
...
Read about websockets in [cometbft Events](/develop/api/cometbft-rpc)
