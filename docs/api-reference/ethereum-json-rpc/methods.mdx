...
| `debug_blockProfile`                                                                  | Debug     | Y          | N      | **Cosmos-specific**|
| `debug_cpuProfile`                                                                    | Debug     | Y          | N      | **Cosmos-specific**|
| `debug_dumpBlock`                                                                     | Debug     |             |        |                    |
| `debug_gcStats`                                                                       | Debug     | Y          | N      | **Cosmos-specific**|
| `debug_getBlockRlp`                                                                   | Debug     | Y          | N      |                    |
...
| `debug_setMutexProfileFraction`                                                       | Debug     | Y          | N      | **Cosmos-specific**|
...
| `debug_getHeaderRlp`                                                                  | Debug     | Y          | N      |                    |
| `debug_intermediateRoots`                                                             | Debug     | Y          | N      |                    |
...
| `miner_start`                                                                         | Miner     | N          | N      | Stub returns true  |
| `miner_stop`                                                                          | Miner     | N          | N      | Stub returns true  |
| `miner_setEtherbase`                                                                  | Miner     | N          | N      | Stub returns true  |
| `miner_setGasPrice`                                                                   | Miner     | N          | N      | Stub returns true  |
| `miner_setGasLimit`                                                                   | Miner     | N          | N      | Stub returns true  |
