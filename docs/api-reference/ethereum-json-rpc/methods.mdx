...
| `eth_feeHistory`                                                                      | Eth       | ✅          | ✅     | EIP-1559           |
| `eth_maxPriorityFeePerGas`                                                            | Eth       | ✅          | ✅     | EIP-1559           |
| `eth_chainId`                                                                         | Eth       | ✅          | ✅     |                    |
| `eth_getBlockReceipts`                                                                | Eth       | ✅          | ✅     |                    |
| `eth_resend`                                                                          | Eth       | ✅          | ❌     |                    |
| `eth_pendingTransactions`                                                             | Eth       | ✅          | ❌     |                    |
...
| [`personal_lockAccount`](#personal_lockaccount)                                       | Personal  | ⚠️         | ❌     | Limited support    |
| [`personal_newAccount`](#personal_newaccount)                                         | Personal  | ✅          | ❌     |                    |
| [`personal_unlockAccount`](#personal_unlockaccount)                                   | Personal  | ⚠️         | ❌     | Limited support    |
...
| `debug_traceCall`                                                                     | Debug     | ❌          | ❌     | Not implemented    |
...
| [`miner_getHashrate`](#miner_gethashrate)                                             | Miner     | ✅          | ❌     | Always 0           |
| [`miner_setExtra`](#miner_setextra)                                                   | Miner     | ✅          | ❌     | Not supported      |
| [`miner_setGasPrice`](#miner_setgasprice)                                             | Miner     | ✅          | ❌     | Needs node restart |
| [`miner_start`](#miner_start)                                                         | Miner     | ✅          | ❌     | Not supported      |
| [`miner_stop`](#miner_stop)                                                           | Miner     | ✅          | ❌     | Not supported      |
| [`miner_setGasLimit`](#miner_setgaslimit)                                             | Miner     | ✅          | ❌     | Not supported      |
| [`miner_setEtherbase`](#miner_setetherbase)                                           | Miner     | ✅          | ❌     |                    |
| [`txpool_content`](#txpool_content)                                                   | TxPool    | ✅          | ✅     | Empty impl         |
| [`txpool_inspect`](#txpool_inspect)                                                   | TxPool    | ✅          | ✅     | Empty impl         |
| [`txpool_status`](#txpool_status)                                                     | TxPool    | ✅          | ✅     | Returns zeros      |
| `trace_callMany`                                                                      | Trace     | ❌          | ❌     | Not implemented    |
