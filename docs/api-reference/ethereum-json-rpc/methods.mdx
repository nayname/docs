...
| `debug_blockProfile`                                                                  | Debug     | N          | N      | Profiling disabled |
| `debug_cpuProfile`                                                                    | Debug     | N          | N      | Profiling disabled |
| `debug_dumpBlock`                                                                     | Debug     | N          | N      | Returns undefined  |
| `debug_gcStats`                                                                       | Debug     | N          | N      | Profiling disabled |
| [`debug_getBlockRlp`](#debug_getblockrlp)                                            | Debug     | N          | N      | Requires uint64 param |
| `debug_goTrace`                                                                       | Debug     | N          | N      | Profiling disabled |
| `debug_freeOSMemory`                                                                  | Debug     | N          | N      | Profiling disabled |
| `debug_memStats`                                                                      | Debug     | N          | N      | Profiling disabled |
| `debug_mutexProfile`                                                                  | Debug     | N          | N      | Profiling disabled |
| `debug_seedHash`                                                                      | Debug     | N          | N      | Not implemented    |
| `debug_setHead`                                                                       | Debug     | N          | N      | Not implemented    |
| `debug_setBlockProfileRate`                                                           | Debug     | N          | N      | Profiling disabled |
| `debug_setGCPercent`                                                                  | Debug     | N          | N      | Profiling disabled |
| `debug_setMutexProfileFraction`                                                       | Debug     | N          | N      | Profiling disabled |
| `debug_stacks`                                                                        | Debug     | N          | N      | Profiling disabled |
| `debug_startCPUProfile`                                                               | Debug     | N          | N      | Profiling disabled |
| `debug_startGoTrace`                                                                  | Debug     | N          | N      | Profiling disabled |
| `debug_stopCPUProfile`                                                                | Debug     | N          | N      | Profiling disabled |
| `debug_stopGoTrace`                                                                   | Debug     | N          | N      | Profiling disabled |
...
| `debug_writeBlockProfile`                                                             | Debug     | N          | N      | Profiling disabled |
| `debug_writeMemProfile`                                                               | Debug     | N          | N      | Profiling disabled |
| `debug_writeMutexProfile`                                                             | Debug     | N          | N      | Profiling disabled |
...
| `debug_intermediateRoots`                                                             | Debug     | N          | N      | Profiling disabled |
...
| [`txpool_status`](#txpool_status)                                                     | TxPool    | Stub       | Y      | Returns empty obj  |
...
For more details on how Cosmos EVM differs from standard Ethereum implementations, see [Differences from Standard EVMs](/docs/documentation/evm-compatibility/differences).
</Info>
