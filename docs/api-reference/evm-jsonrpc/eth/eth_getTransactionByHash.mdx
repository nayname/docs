...
// Example call
const result = await web3.eth.getTransactionByHash(0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890);
console.log(result);
```
...
// Example call
const result = await provider.send('eth_getTransactionByHash', ["0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890"]);
console.log(result);
```
...
// Example call
result = w3.manager.request_blocking('eth_getTransactionByHash', ['0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890'])
print(result)
```
</CodeGroup>
