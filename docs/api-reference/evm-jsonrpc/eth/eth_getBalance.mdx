...
// Example call
const result = await web3.eth.getBalance(0x742d35cc6644c068532fddb11B4C36A58D6D3eAb, latest);
console.log(result);
```
...
// Example call
const result = await provider.send('eth_getBalance', ["0x742d35cc6644c068532fddb11B4C36A58D6D3eAb", "latest"]);
console.log(result);
```
...
// Example call
result = w3.manager.request_blocking('eth_getBalance', ['0x742d35cc6644c068532fddb11B4C36A58D6D3eAb', 'latest'])
print(result)
```
</CodeGroup>
