...
curl -X POST https://evm-rpc.cosmos.network \
  ...
  -d '{
    ...
    "params": [{"to": "0x742d35cc6644c068532fddb11B4C36A58D6D3eAb", "value": "0x1000000000000000000", "gas": "0x5208"}],
    "id": 1
  }'
```
...
// Example call
const result = await web3.eth.sendTransaction({'to': '0x742d35cc6644c068532fddb11B4C36A58D6D3eAb', 'value': '0x1000000000000000000', 'gas': '0x5208'});
console.log(result);
```
...
// Example call
const result = await provider.send('eth_sendTransaction', [{"to": "0x742d35cc6644c068532fddb11B4C36A58D6D3eAb", "value": "0x1000000000000000000", "gas": "0x5208"}]);
console.log(result);
```
...
// Example call
result = w3.manager.request_blocking('eth_sendTransaction', [{'to': '0x742d35cc6644c068532fddb11B4C36A58D6D3eAb', 'value': '0x1000000000000000000', 'gas': '0x5208'}])
print(result)
```
</CodeGroup>
