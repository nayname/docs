...
2. `full_transactions` - Parameter description
...
// Example call
const result = await web3.eth.getBlockByHash(0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef, false);
console.log(result);
```
...
// Example call
const result = await provider.send('eth_getBlockByHash', ["0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef", "false"]);
console.log(result);
```
...
// Example call
result = w3.manager.request_blocking('eth_getBlockByHash', ['0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef', 'false'])
print(result)
```
</CodeGroup>
