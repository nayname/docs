...
1. `block_hash` - Parameter description
2. `index` - Parameter description
...
curl -X POST https://evm-rpc.cosmos.network \
  ...
  -d '{
    ...
    "params": ["0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef", "0x0"],
    "id": 1
  }'
```
...
// Example call
const result = await web3.eth.getTransactionByBlockHashAndIndex(0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef, 0x0);
console.log(result);
```
...
// Example call
const result = await provider.send('eth_getTransactionByBlockHashAndIndex', ["0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef", "0x0"]);
console.log(result);
```
...
// Example call
result = w3.manager.request_blocking('eth_getTransactionByBlockHashAndIndex', ['0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef', '0x0'])
print(result)
```
</CodeGroup>
