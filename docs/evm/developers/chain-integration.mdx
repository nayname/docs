...
<CardGroup cols={3}>
  ...
  <Card title="x/feemarket Module" icon="credit-card">
    EIP-1559 fee market mechanism for dynamic pricing
  </Card>
  <Card title="x/erc20 Module" icon="coins">
    Token unification between Cosmos SDK coins and ERC-20
  </Card>
</CardGroup>

### Optional Module

<Card title="x/precisebank Module" icon="precision">
  **Optional:** Extends bank module precision from 6 to 18 decimals for EVM compatibility. This module serves as a wrapper around x/bank to provide the 18-decimal precision expected by EVM applications while preserving existing Cosmos SDK behavior.
</Card>
