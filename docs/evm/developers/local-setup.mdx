...
<CardGroup cols={2}>
  <Card title="Cosmos RPC" icon="atom">
    **URL:** `http://localhost:26657`

    **Usage:** Cosmos SDK queries and transactions
    ```bash
    curl http://localhost:26657/status
    ```
  </Card>

  <Card title="EVM JSON-RPC" icon="ethereum">
    **URL:** `http://localhost:8545`

    **Usage:** Ethereum-compatible tools (MetaMask, Hardhat)
    ```bash
