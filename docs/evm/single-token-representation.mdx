...
### WERC20 Precompile
The WERC20 precompile is the primary implementation of single token representation for native tokens. For detailed technical information about interfaces, methods, and implementation details, see the [WERC20 documentation](/docs/devnet/precompiles/werc20).

### ERC20 Module
The underlying x/erc20 module manages token pair registrations and provides the infrastructure for single token representation. Learn more in the [ERC20 module documentation](/docs/devnet/precompiles/erc20).

### Bank Precompile
The bank precompile provides direct access to native token balances and operations. See [Bank precompile documentation](/docs/devnet/precompiles/bank) for query interfaces and methods.
