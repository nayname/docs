...
Most components are implemented in the [VM module](/docs/evm/next/documentation/cosmos-sdk/modules/vm) To achieve a seamless developer UX, however, some of the components are implemented outside of the module.
