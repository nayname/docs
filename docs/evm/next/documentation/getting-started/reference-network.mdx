...
- **Try it out**: [Set up your local evmd network](/docs/evm/next/documentation/getting-started/local-network-setup)
- **Configure**: [Node configuration options](/docs/evm/next/documentation/getting-started/node-configuration)
- **Integrate**: [Add EVM compatibility to your chain](/docs/evm/next/documentation/integration/evm-module-integration)
