...
- [Precompiles](/docs/evm/next/documentation/smart-contracts/precompiles) - Native chain implementations exposed as smart contracts
- [Gas and Fees](/docs/evm/next/documentation/concepts/gas-and-fees) - Understanding gas consumption for predeployed contracts
- [Chain ID](/docs/evm/next/documentation/concepts/chain-id) - How chain identity affects contract addresses
- [Implementation Guide](/docs/evm/next/documentation/integration/predeployed-contracts-integration) - Technical details for deploying and managing preinstalled contracts