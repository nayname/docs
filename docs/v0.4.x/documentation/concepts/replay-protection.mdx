...
As documented in the [Chain ID](/v0.4.x/documentation/concepts/chain-id) page, Cosmos EVM uses:
...
- [Chain ID Configuration](/v0.4.x/documentation/concepts/chain-id)
- [Transaction Types](/v0.4.x/documentation/concepts/transactions#ethereum-tx-type)
- [EVM Module Parameters](/v0.4.x/documentation/cosmos-sdk/modules/vm#parameters)