...
- [Precompiles](/v0.4.x/documentation/smart-contracts/precompiles) - Native chain implementations exposed as smart contracts
- [Gas and Fees](/v0.4.x/documentation/concepts/gas-and-fees) - Understanding gas consumption for predeployed contracts
- [Chain ID](/v0.4.x/documentation/concepts/chain-id) - How chain identity affects contract addresses
- [Implementation Guide](/v0.4.x/documentation/smart-contracts/predeployed-contracts/overview) - Technical details for deploying and managing preinstalled contracts