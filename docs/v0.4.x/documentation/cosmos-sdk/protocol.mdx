...
* Exposing a fully compatible Web3 [JSON-RPC](/v0.4.x/api-reference/ethereum-json-rpc/methods) layer for interacting with existing Ethereum clients and tooling (Metamask, Remix, etc).
...
* [JSON-RPC](/v0.4.x/api-reference/ethereum-json-rpc) client for interacting with the EVM

Most components are implemented in the [VM module](/v0.4.x/documentation/cosmos-sdk/modules/vm) To achieve a seamless developer UX, however, some of the components are implemented outside of the module.
...
* [Accounts](/v0.4.x/documentation/concepts/accounts)
* [Gas and Fees](/v0.4.x/documentation/concepts/gas-and-fees)
* [Token representations](/v0.4.x/documentation/concepts/tokens)
* [Transactions](/v0.4.x/documentation/concepts/transactions)
