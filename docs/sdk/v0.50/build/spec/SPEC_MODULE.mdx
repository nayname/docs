...
## Tense[​](#tense "Direct link to Tense")

For consistency, specs should be written in passive present tense.

## Pseudo-Code[​](#pseudo-code "Direct link to Pseudo-Code")
...
## Common Layout[​](#common-layout "Direct link to Common Layout")
...
### Notation for key-value mapping[​](#notation-for-key-value-mapping "Direct link to Notation for key-value mapping")
