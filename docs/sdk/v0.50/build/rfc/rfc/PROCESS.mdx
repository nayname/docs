...
4. Add an entry to a list in the [README](/v0.50/build/rfc/rfc) file.
5. Create a Pull Request to propose a new ADR.

## What is an RFC?[​](#what-is-an-rfc "Direct link to What is an RFC?")
...
## RFC life cycle[​](#rfc-life-cycle "Direct link to RFC life cycle")
...
### RFC status[​](#rfc-status "Direct link to RFC status")
...
## Language used in RFC[​](#language-used-in-rfc "Direct link to Language used in RFC")
