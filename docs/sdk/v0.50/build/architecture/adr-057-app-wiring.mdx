...
modules for Cosmos SDK modules as described in [ADR 053: Go Module Refactoring](/docs/sdk/v0.50/adr-053-go-module-refactoring).
...
Several attempts were made to improve the current situation including [ADR 033: Internal-Module Communication](/docs/sdk/v0.50/adr-033-protobuf-inter-module-comm)
...
described in [ADR 063: Core Module API](/docs/sdk/v0.50/adr-063-core-module-api).
...
defined here are described in [ADR 063: Core Module API](/docs/sdk/v0.50/adr-063-core-module-api).
...
[ADR 054: Module Semantic Versioning](/docs/sdk/v0.50/adr-054-semver-compatible-modules) are
