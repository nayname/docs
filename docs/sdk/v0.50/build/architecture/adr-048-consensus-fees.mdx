...
## Multi-Tier Price System[​](#multi-tier-price-system "Direct link to Multi-Tier Price System")
...
```
message ExtensionOptionsTieredTx {  uint32 fee_tier = 1}
```
...
### Tx Prioritization[​](#tx-prioritization "Direct link to Tx Prioritization")
...
### `min-gas-prices`[​](#min-gas-prices "Direct link to min-gas-prices")
...
### Adjust For Block Load[​](#adjust-for-block-load "Direct link to Adjust For Block Load")
...
* [https://iohk.io/en/blog/posts/2021/11/26/network-traffic-and-tiered-pricing/](https://iohk.io/en/blog/posts/2021/11/26/network-traffic-and-tiered-pricing/)
