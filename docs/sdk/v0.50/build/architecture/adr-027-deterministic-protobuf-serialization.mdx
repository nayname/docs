...
For signature verification in Cosmos SDK, the signer and verifier need to agree on the same serialization of a `SignDoc` as defined in [ADR-020](/v0.50/build/architecture/adr-020-protobuf-transaction-encoding) without transmitting the serialization.
