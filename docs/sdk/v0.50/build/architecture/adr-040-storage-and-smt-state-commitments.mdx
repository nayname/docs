...
### Decouple state commitment from storage[​](#decouple-state-commitment-from-storage "Direct link to Decouple state commitment from storage")
...
### SMT for State Commitment[​](#smt-for-state-commitment "Direct link to SMT for State Commitment")
...
### Snapshots for storage sync and state versioning[​](#snapshots-for-storage-sync-and-state-versioning "Direct link to Snapshots for storage sync and state versioning")
...
#### Accessing old state versions[​](#accessing-old-state-versions "Direct link to Accessing old state versions")
...
### State Proofs[​](#state-proofs "Direct link to State Proofs")
...
### Committing to an object without saving it[​](#committing-to-an-object-without-saving-it "Direct link to Committing to an object without saving it")
...
### Refactor MultiStore[​](#refactor-multistore "Direct link to Refactor MultiStore")
...
#### Compatibility support[​](#compatibility-support "Direct link to Compatibility support")
...
#### Merkle Proofs and IBC[​](#merkle-proofs-and-ibc "Direct link to Merkle Proofs and IBC")
...
### Optimization: compress module key prefixes[​](#optimization-compress-module-key-prefixes "Direct link to Optimization: compress module key prefixes")
...
## Optimization: SS key compression[​](#optimization-ss-key-compression "Direct link to Optimization: SS key compression")
...
```
app.UpgradeKeeper.SetUpgradeHandler("adr-40", func(ctx sdk.Context, plan upgradetypes.Plan, vm module.VersionMap) (module.VersionMap, error) {    storev2.Migrate(iavlstore, v2.store)    // RunMigrations returns the VersionMap    // with the updated module ConsensusVersions    return app.mm.RunMigrations(ctx, vm)})
```
...
## Alternative designs[​](#alternative-designs "Direct link to Alternative designs")
...
### Evaluated KV Databases[​](#evaluated-kv-databases "Direct link to Evaluated KV Databases")
...
### RDBMS[​](#rdbms "Direct link to RDBMS")
...
### Off Chain Store[​](#off-chain-store "Direct link to Off Chain Store")
