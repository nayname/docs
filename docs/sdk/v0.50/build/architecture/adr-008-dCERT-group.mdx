...
The dCERT group is proposed to include an implementation of a `SpecializationGroup` as defined in [ADR 007](/v0.50/build/architecture/adr-007-specialization-groups). This will include the implementation of:
...
### Continuous Voting Electionator[​](#continuous-voting-electionator "Direct link to Continuous Voting Electionator")
...
### Staking/Slashing[​](#stakingslashing "Direct link to Staking/Slashing")
...
### dCERT membership transactions[​](#dcert-membership-transactions "Direct link to dCERT membership transactions")
...
[Specialization Groups ADR](/v0.50/build/architecture/adr-007-specialization-groups)
