...
<Note>
  * [Cosmos Blockchain Simulator](/v0.50/learn/advanced/simulation)
</Note>
...
Operations on the simulation are simulated using the full [transaction cycle](/v0.50/learn/advanced/transactions) of a `ABCI` application that exposes the `BaseApp`.
