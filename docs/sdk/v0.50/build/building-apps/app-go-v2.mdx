...
The Cosmos SDK allows much easier wiring of an `app.go` thanks to App Wiring and [`depinject`](/docs/sdk/v0.50/build/packages/depinject).
...
* [Modules depinject-ready](/docs/sdk/v0.50/build/building-modules/depinject)
