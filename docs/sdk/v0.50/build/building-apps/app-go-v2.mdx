...
<Note>
  The Cosmos SDK allows much easier wiring of an `app.go` thanks to App Wiring and [`depinject`](/v0.50/build/packages/depinject). Learn more about the rationale of App Wiring in [ADR-057](/v0.50/build/architecture/adr-057-app-wiring).
</Note>

<Note>
  * [ADR 057: App Wiring](/v0.50/build/architecture/adr-057-app-wiring)
  * [Depinject Documentation](/v0.50/build/packages/depinject)
  * [Modules depinject-ready](/v0.50/build/building-modules/depinject)
</Note>
...
1. Create the `AppConfig` variable:
   ...
   [See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_config.go#L103)
...
2. Configure the `runtime` module:
   ...
   [See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_config.go#L103-L167)
...
3. Configure the modules defined in the `PreBlocker`, `BeginBlocker` and `EndBlocker` and the `tx` module:
   ...
   [See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_config.go#L112-L129)
   ...
   [See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_config.go#L200-L203)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_config.go)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_v2.go#L101-L245)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_v2.go#L114-L146)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.50.0-alpha.0/simapp/app_v2.go)
