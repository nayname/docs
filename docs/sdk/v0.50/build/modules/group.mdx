...
Location: off-chain as json object stored on IPFS (mirrors [gov proposal](/v0.50/build/modules/gov#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [gov vote](/v0.50/build/modules/gov#metadata))
