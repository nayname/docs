...
```
type ExampleKeeper struct {    paramSpace paramtypes.Subspace}func (k ExampleKeeper) SetParams(ctx sdk.Context, params types.Params) {    k.paramSpace.SetParamSet(ctx, &params)}
```

## Subspace[​](#subspace "Direct link to Subspace")
...
### KeyTable[​](#keytable "Direct link to KeyTable")
...
### ParamSet[​](#paramset "Direct link to ParamSet")
