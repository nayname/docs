...
```
type Plan struct {  Name   string  Height int64  Info   string}
```

#### Sidecar Process[​](#sidecar-process "Direct link to Sidecar Process")
...
### StoreLoader[​](#storeloader "Direct link to StoreLoader")
...
#### Cancelling Upgrade Proposals[​](#cancelling-upgrade-proposals "Direct link to Cancelling Upgrade Proposals")
...
##### applied[​](#applied "Direct link to applied")
...
```
module_versions:- name: auth  version: "2"- name: authz  version: "1"- name: bank  version: "2"- name: crisis  version: "1"- name: distribution  version: "2"- name: evidence  version: "1"- name: feegrant  version: "1"- name: genutil  version: "1"- name: gov  version: "2"- name: ibc  version: "2"- name: mint  version: "1"- name: params  version: "1"- name: slashing  version: "2"- name: staking  version: "2"- name: transfer  version: "1"- name: upgrade  version: "1"- name: vesting  version: "1"
```
...
```
module_versions:- name: ibc  version: "2"
```

##### plan[​](#plan-1 "Direct link to plan")
...
```
height: "130"info: ""name: test-upgradetime: "0001-01-01T00:00:00Z"upgraded_client_state: null
```
...
```
simd tx upgrade software-upgrade v2 --title="Test Proposal" --summary="testing" --deposit="100000000stake" --upgrade-height 1000000 \--upgrade-info '{ "binaries": { "linux/amd64":"https://example.com/simd.zip?checksum=sha256:aec070645fe53ee3b3763059376134f058cc337247c978add178b6ccdfb0019f" } }' --from cosmos1..
```
...
#### Applied Plan[​](#applied-plan "Direct link to Applied Plan")
...
#### Current Plan[​](#current-plan "Direct link to Current Plan")
...
#### Module versions[​](#module-versions-1 "Direct link to Module versions")
...
#### Applied Plan[​](#applied-plan-1 "Direct link to Applied Plan")
...
```
grpcurl -plaintext \    -d '{"name":"v2.0-upgrade"}' \    localhost:9090 \    cosmos.upgrade.v1beta1.Query/AppliedPlan
```
...
#### Current Plan[​](#current-plan-1 "Direct link to Current Plan")
...
#### Module versions[​](#module-versions-2 "Direct link to Module versions")
