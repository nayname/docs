...
**Note:** The authz module is different from the [auth (authentication)](/v0.50/build/modules/auth) module that is responsible for specifying the base transaction and account types.
