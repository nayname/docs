...
#### add-genesis-account[​](#add-genesis-account "Direct link to add-genesis-account")
...
#### collect-gentxs[​](#collect-gentxs "Direct link to collect-gentxs")
...
#### gentx[​](#gentx "Direct link to gentx")
...
#### validate-genesis[​](#validate-genesis "Direct link to validate-genesis")
