...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/v0.50/build/modules/group#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/v0.50/build/modules/group#metadata))
