...
## Step 1: Compile and Install the Application[​](#step-1-compile-and-install-the-application "Direct link to Step 1: Compile and Install the Application")
...
## Step 2: Initialise the Application[​](#step-2-initialise-the-application "Direct link to Step 2: Initialise the Application")
...
## Step 3: Start the Application[​](#step-3-start-the-application "Direct link to Step 3: Start the Application")
...
## Step 4: Query the Oracle Prices[​](#step-4-query-the-oracle-prices "Direct link to Step 4: Query the Oracle Prices")
...
## Understanding Vote Extensions in Oracle[​](#understanding-vote-extensions-in-oracle "Direct link to Understanding Vote Extensions in Oracle")
