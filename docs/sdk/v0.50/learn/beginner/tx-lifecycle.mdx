...
Additionally, there are several [flags](/docs/sdk/v0.50/learn/advanced/cli) users can use to indicate how much they are willing to pay in [fees](/docs/sdk/v0.50/gas-fees):
