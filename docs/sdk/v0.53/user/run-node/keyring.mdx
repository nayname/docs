...
<Note>
  This document describes how to configure and use the keyring and its various backends for an [**application**](/v0.53/learn/beginner/app-anatomy).
</Note>
