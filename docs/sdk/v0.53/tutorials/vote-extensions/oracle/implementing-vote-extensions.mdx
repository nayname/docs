...
## Implement ExtendVote[​](#implement-extendvote "Direct link to Implement ExtendVote")
...
## Implement PrepareProposal[​](#implement-prepareproposal "Direct link to Implement PrepareProposal")
...
## Implement ProcessProposal[​](#implement-processproposal "Direct link to Implement ProcessProposal")
...
Then we re-validate the vote extensions signatures using baseapp.ValidateVoteExtensions, re-calculate the results (just like in PrepareProposal) and compare them with the results we got from the injected tx.
...
Important: In this example we avoided using the mempool and other basics, please refer to the DefaultProposalHandler for a complete implementation: [https://github.com/cosmos/cosmos-sdk/blob/v0.50.1/baseapp/abci\_utils.go](https://github.com/cosmos/cosmos-sdk/blob/v0.50.1/baseapp/abci_utils.go)

## Implement PreBlocker[​](#implement-preblocker "Direct link to Implement PreBlocker")
