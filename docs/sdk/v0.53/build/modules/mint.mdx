...
### The Minting Mechanism[​](#the-minting-mechanism "Direct link to The Minting Mechanism")
...
### Custom Minters[​](#custom-minters "Direct link to Custom Minters")
...
#### Custom Minter DI Example[​](#custom-minter-di-example "Direct link to Custom Minter DI Example")

Below is a simple approach to creating a custom mint function with extra dependencies in DI configurations. For this basic example, we will make the minter simply double the supply of `foo` coin.
...
### Minter[​](#minter "Direct link to Minter")
...
### Inflation rate calculation[​](#inflation-rate-calculation "Direct link to Inflation rate calculation")
...
#### NextInflationRate[​](#nextinflationrate "Direct link to NextInflationRate")
...
### NextAnnualProvisions[​](#nextannualprovisions "Direct link to NextAnnualProvisions")
...
```
NextAnnualProvisions(params Params, totalSupply math.LegacyDec) (provisions math.LegacyDec) {    return Inflation * totalSupply
```

### BlockProvision[​](#blockprovision "Direct link to BlockProvision")

Calculate the provisions generated for each block based on current annual provisions. The provisions are then minted by the `mint` module's `ModuleMinterAccount` and then transferred to the `auth`'s `FeeCollector` `ModuleAccount`.

```
BlockProvision(params Params) sdk.Coin {    provisionAmt = AnnualProvisions/ params.BlocksPerYear    return sdk.NewCoin(params.MintDenom, provisionAmt.Truncate())
```
...
##### annual-provisions[​](#annual-provisions "Direct link to annual-provisions")
...
```
blocks_per_year: "4360000"goal_bonded: "0.670000000000000000"inflation_max: "0.200000000000000000"inflation_min: "0.070000000000000000"inflation_rate_change: "0.130000000000000000"mint_denom: stake
```
...
#### AnnualProvisions[​](#annualprovisions "Direct link to AnnualProvisions")
...
#### Inflation[​](#inflation-1 "Direct link to Inflation")
...
```
{  "params": {    "mintDenom": "stake",    "inflationRateChange": "130000000000000000",    "inflationMax": "200000000000000000",    "inflationMin": "70000000000000000",    "goalBonded": "670000000000000000",    "blocksPerYear": "6311520"  }}
```
...
#### annual-provisions[​](#annual-provisions-1 "Direct link to annual-provisions")
...
#### inflation[​](#inflation-2 "Direct link to inflation")
