...
### Decision Policy[​](#decision-policy "Direct link to Decision Policy")
...
v0.50.x/x/group/types.go

```
loading...
```

[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/x/group/types.go#L27-L45)

#### Threshold decision policy[​](#threshold-decision-policy "Direct link to Threshold decision policy")
...
#### Percentage decision policy[​](#percentage-decision-policy "Direct link to Percentage decision policy")
...
### Proposal[​](#proposal "Direct link to Proposal")
...
#### Voting[​](#voting "Direct link to Voting")
...
#### Withdrawing Proposals[​](#withdrawing-proposals "Direct link to Withdrawing Proposals")
...
#### Aborted Proposals[​](#aborted-proposals "Direct link to Aborted Proposals")
...
#### Tallying[​](#tallying "Direct link to Tallying")
...
#### Executing Proposals[​](#executing-proposals "Direct link to Executing Proposals")
...
### Group Table[​](#group-table "Direct link to Group Table")

The `groupTable` stores `GroupInfo`: `0x0 | BigEndian(GroupId) -> ProtocolBuffer(GroupInfo)`.

#### groupSeq[​](#groupseq "Direct link to groupSeq")
...
#### groupByAdminIndex[​](#groupbyadminindex "Direct link to groupByAdminIndex")
...
### Group Member Table[​](#group-member-table "Direct link to Group Member Table")
...
#### groupMemberByGroupIndex[​](#groupmemberbygroupindex "Direct link to groupMemberByGroupIndex")

`groupMemberByGroupIndex` allows to retrieve group members by group id: `0x11 | BigEndian(GroupId) | PrimaryKey -> []byte()`.

#### groupMemberByMemberIndex[​](#groupmemberbymemberindex "Direct link to groupMemberByMemberIndex")
...
### Group Policy Table[​](#group-policy-table "Direct link to Group Policy Table")
...
#### groupPolicySeq[​](#grouppolicyseq "Direct link to groupPolicySeq")
...
#### groupPolicyByGroupIndex[​](#grouppolicybygroupindex "Direct link to groupPolicyByGroupIndex")

`groupPolicyByGroupIndex` allows to retrieve group policies by group id: `0x22 | BigEndian(GroupId) | PrimaryKey -> []byte()`.

#### groupPolicyByAdminIndex[​](#grouppolicybyadminindex "Direct link to groupPolicyByAdminIndex")
...
### Proposal Table[​](#proposal-table "Direct link to Proposal Table")

The `proposalTable` stores `Proposal`s: `0x30 | BigEndian(ProposalId) -> ProtocolBuffer(Proposal)`.

#### proposalSeq[​](#proposalseq "Direct link to proposalSeq")
...
#### proposalByGroupPolicyIndex[​](#proposalbygrouppolicyindex "Direct link to proposalByGroupPolicyIndex")
...
#### ProposalsByVotingPeriodEndIndex[​](#proposalsbyvotingperiodendindex "Direct link to ProposalsByVotingPeriodEndIndex")
...
### Vote Table[​](#vote-table "Direct link to Vote Table")
...
#### voteByProposalIndex[​](#votebyproposalindex "Direct link to voteByProposalIndex")

`voteByProposalIndex` allows to retrieve votes by proposal id: `0x41 | BigEndian(ProposalId) | PrimaryKey -> []byte()`.

#### voteByVoterIndex[​](#votebyvoterindex "Direct link to voteByVoterIndex")
...
## Msg Service[​](#msg-service "Direct link to Msg Service")

### Msg/CreateGroup[​](#msgcreategroup "Direct link to Msg/CreateGroup")
...
v0.50.x/proto/cosmos/group/v1/tx.proto

```
loading...
```

[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L67-L80)
...
### Msg/UpdateGroupMembers[​](#msgupdategroupmembers "Direct link to Msg/UpdateGroupMembers")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L88-L102)
...
### Msg/UpdateGroupAdmin[​](#msgupdategroupadmin "Direct link to Msg/UpdateGroupAdmin")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L107-L120)

It's expected to fail if the signer is not the admin of the group.

### Msg/UpdateGroupMetadata[​](#msgupdategroupmetadata "Direct link to Msg/UpdateGroupMetadata")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L125-L138)
...
### Msg/CreateGroupPolicy[​](#msgcreategrouppolicy "Direct link to Msg/CreateGroupPolicy")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L147-L165)
...
### Msg/CreateGroupWithPolicy[​](#msgcreategroupwithpolicy "Direct link to Msg/CreateGroupWithPolicy")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L191-L215)

It's expected to fail for the same reasons as `Msg/CreateGroup` and `Msg/CreateGroupPolicy`.

### Msg/UpdateGroupPolicyAdmin[​](#msgupdategrouppolicyadmin "Direct link to Msg/UpdateGroupPolicyAdmin")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L173-L186)

It's expected to fail if the signer is not the admin of the group policy.

### Msg/UpdateGroupPolicyDecisionPolicy[​](#msgupdategrouppolicydecisionpolicy "Direct link to Msg/UpdateGroupPolicyDecisionPolicy")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L226-L241)
...
### Msg/UpdateGroupPolicyMetadata[​](#msgupdategrouppolicymetadata "Direct link to Msg/UpdateGroupPolicyMetadata")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L246-L259)
...
### Msg/SubmitProposal[​](#msgsubmitproposal "Direct link to Msg/SubmitProposal")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L281-L315)
...
### Msg/WithdrawProposal[​](#msgwithdrawproposal "Direct link to Msg/WithdrawProposal")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L323-L333)
...
### Msg/Vote[​](#msgvote "Direct link to Msg/Vote")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L338-L358)
...
### Msg/Exec[​](#msgexec "Direct link to Msg/Exec")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L363-L373)
...
### Msg/LeaveGroup[​](#msgleavegroup "Direct link to Msg/LeaveGroup")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/tree/release/v0.50.x/proto/cosmos/group/v1/tx.proto#L381-L391)
...
### EventCreateGroup[​](#eventcreategroup "Direct link to EventCreateGroup")
...
### EventUpdateGroup[​](#eventupdategroup "Direct link to EventUpdateGroup")
...
### EventCreateGroupPolicy[​](#eventcreategrouppolicy "Direct link to EventCreateGroupPolicy")
...
### EventUpdateGroupPolicy[​](#eventupdategrouppolicy "Direct link to EventUpdateGroupPolicy")
...
### EventCreateProposal[​](#eventcreateproposal "Direct link to EventCreateProposal")
...
### EventWithdrawProposal[​](#eventwithdrawproposal "Direct link to EventWithdrawProposal")
...
### EventVote[​](#eventvote "Direct link to EventVote")
...
## EventExec[​](#eventexec "Direct link to EventExec")
...
### EventLeaveGroup[​](#eventleavegroup "Direct link to EventLeaveGroup")
...
### EventProposalPruned[​](#eventproposalpruned "Direct link to EventProposalPruned")
...
##### group-info[​](#group-info "Direct link to group-info")
...
```
admin: cosmos1..group_id: "1"metadata: AQ==total_weight: "3"version: "1"
```

##### group-policy-info[​](#group-policy-info "Direct link to group-policy-info")
...
```
address: cosmos1..admin: cosmos1..decision_policy:  '@type': /cosmos.group.v1.ThresholdDecisionPolicy  threshold: "1"  windows:      min_execution_period: 0s      voting_period: 432000sgroup_id: "1"metadata: AQ==version: "1"
```

##### group-members[​](#group-members "Direct link to group-members")
...
```
members:- group_id: "1"  member:    address: cosmos1..    metadata: AQ==    weight: "2"- group_id: "1"  member:    address: cosmos1..    metadata: AQ==    weight: "1"pagination:  next_key: null  total: "2"
```

##### groups-by-admin[​](#groups-by-admin "Direct link to groups-by-admin")
...
```
groups:- admin: cosmos1..  group_id: "1"  metadata: AQ==  total_weight: "3"  version: "1"- admin: cosmos1..  group_id: "2"  metadata: AQ==  total_weight: "3"  version: "1"pagination:  next_key: null  total: "2"
```

##### group-policies-by-group[​](#group-policies-by-group "Direct link to group-policies-by-group")
...
##### group-policies-by-admin[​](#group-policies-by-admin "Direct link to group-policies-by-admin")
...
##### proposal[​](#proposal-1 "Direct link to proposal")
...
##### proposals-by-group-policy[​](#proposals-by-group-policy "Direct link to proposals-by-group-policy")
...
```
vote:  choice: CHOICE_YES  metadata: AQ==  proposal_id: "1"  submitted_at: "2021-12-17T08:05:02.490164009Z"  voter: cosmos1..
```

##### votes-by-proposal[​](#votes-by-proposal "Direct link to votes-by-proposal")
...
```
pagination:  next_key: null  total: "1"votes:- choice: CHOICE_YES  metadata: AQ==  proposal_id: "1"  submitted_at: "2021-12-17T08:05:02.490164009Z"  voter: cosmos1..
```

##### votes-by-voter[​](#votes-by-voter "Direct link to votes-by-voter")
...
#### update-group-admin[​](#update-group-admin "Direct link to update-group-admin")
...
#### update-group-members[​](#update-group-members "Direct link to update-group-members")
...
#### update-group-metadata[​](#update-group-metadata "Direct link to update-group-metadata")
...
#### create-group-policy[​](#create-group-policy "Direct link to create-group-policy")
...
#### create-group-with-policy[​](#create-group-with-policy "Direct link to create-group-with-policy")
...
#### update-group-policy-admin[​](#update-group-policy-admin "Direct link to update-group-policy-admin")
...
#### update-group-policy-metadata[​](#update-group-policy-metadata "Direct link to update-group-policy-metadata")
...
#### update-group-policy-decision-policy[​](#update-group-policy-decision-policy "Direct link to update-group-policy-decision-policy")
...
#### submit-proposal[​](#submit-proposal "Direct link to submit-proposal")
...
#### withdraw-proposal[​](#withdraw-proposal "Direct link to withdraw-proposal")
...
#### vote[​](#vote-1 "Direct link to vote")
...
#### leave-group[​](#leave-group "Direct link to leave-group")
...
#### GroupInfo[​](#groupinfo "Direct link to GroupInfo")
...
```
grpcurl -plaintext \    -d '{"group_id":1}' localhost:9090 cosmos.group.v1.Query/GroupInfo
```

Example Output:

```
{  "info": {    "groupId": "1",    "admin": "cosmos1..",    "metadata": "AQ==",    "version": "1",    "totalWeight": "3"  }}
```

#### GroupPolicyInfo[​](#grouppolicyinfo "Direct link to GroupPolicyInfo")
...
```
grpcurl -plaintext \    -d '{"address":"cosmos1.."}'  localhost:9090 cosmos.group.v1.Query/GroupPolicyInfo
```

Example Output:

```
{  "info": {    "address": "cosmos1..",    "groupId": "1",    "admin": "cosmos1..",    "version": "1",    "decisionPolicy": {"@type":"/cosmos.group.v1.ThresholdDecisionPolicy","threshold":"1","windows": {"voting_period": "120h", "min_execution_period": "0s"}},  }}
```

#### GroupMembers[​](#groupmembers "Direct link to GroupMembers")
...
```
grpcurl -plaintext \    -d '{"group_id":"1"}'  localhost:9090 cosmos.group.v1.Query/GroupMembers
```

Example Output:

```
{  "members": [    {      "groupId": "1",      "member": {        "address": "cosmos1..",        "weight": "1"      }    },    {      "groupId": "1",      "member": {        "address": "cosmos1..",        "weight": "2"      }    }  ],  "pagination": {    "total": "2"  }}
```

#### GroupsByAdmin[​](#groupsbyadmin "Direct link to GroupsByAdmin")
...
```
grpcurl -plaintext \    -d '{"admin":"cosmos1.."}'  localhost:9090 cosmos.group.v1.Query/GroupsByAdmin
```

Example Output:

```
{  "groups": [    {      "groupId": "1",      "admin": "cosmos1..",      "metadata": "AQ==",      "version": "1",      "totalWeight": "3"    },    {      "groupId": "2",      "admin": "cosmos1..",      "metadata": "AQ==",      "version": "1",      "totalWeight": "3"    }  ],  "pagination": {    "total": "2"  }}
```

#### GroupPoliciesByGroup[​](#grouppoliciesbygroup "Direct link to GroupPoliciesByGroup")
...
```
grpcurl -plaintext \    -d '{"group_id":"1"}'  localhost:9090 cosmos.group.v1.Query/GroupPoliciesByGroup
```
...
#### GroupPoliciesByAdmin[​](#grouppoliciesbyadmin "Direct link to GroupPoliciesByAdmin")
...
```
grpcurl -plaintext \    -d '{"admin":"cosmos1.."}'  localhost:9090 cosmos.group.v1.Query/GroupPoliciesByAdmin
```
...
#### Proposal[​](#proposal-2 "Direct link to Proposal")
...
```
grpcurl -plaintext \    -d '{"proposal_id":"1"}'  localhost:9090 cosmos.group.v1.Query/Proposal
```
...
#### ProposalsByGroupPolicy[​](#proposalsbygrouppolicy "Direct link to ProposalsByGroupPolicy")
...
```
grpcurl -plaintext \    -d '{"address":"cosmos1.."}'  localhost:9090 cosmos.group.v1.Query/ProposalsByGroupPolicy
```
...
#### VoteByProposalVoter[​](#votebyproposalvoter "Direct link to VoteByProposalVoter")
...
```
grpcurl -plaintext \    -d '{"proposal_id":"1","voter":"cosmos1.."}'  localhost:9090 cosmos.group.v1.Query/VoteByProposalVoter
```

Example Output:

```
{  "vote": {    "proposalId": "1",    "voter": "cosmos1..",    "choice": "CHOICE_YES",    "submittedAt": "2021-12-17T08:05:02.490164009Z"  }}
```

#### VotesByProposal[​](#votesbyproposal "Direct link to VotesByProposal")
...
```
grpcurl -plaintext \    -d '{"proposal_id":"1"}'  localhost:9090 cosmos.group.v1.Query/VotesByProposal
```

Example Output:

```
{  "votes": [    {      "proposalId": "1",      "voter": "cosmos1..",      "choice": "CHOICE_YES",      "submittedAt": "2021-12-17T08:05:02.490164009Z"    }  ],  "pagination": {    "total": "1"  }}
```

#### VotesByVoter[​](#votesbyvoter "Direct link to VotesByVoter")
...
```
grpcurl -plaintext \    -d '{"voter":"cosmos1.."}'  localhost:9090 cosmos.group.v1.Query/VotesByVoter
```
...
#### GroupInfo[​](#groupinfo-1 "Direct link to GroupInfo")
...
```
{  "info": {    "id": "1",    "admin": "cosmos1..",    "metadata": "AQ==",    "version": "1",    "total_weight": "3"  }}
```

#### GroupPolicyInfo[​](#grouppolicyinfo-1 "Direct link to GroupPolicyInfo")
...
```
{  "info": {    "address": "cosmos1..",    "group_id": "1",    "admin": "cosmos1..",    "metadata": "AQ==",    "version": "1",    "decision_policy": {      "@type": "/cosmos.group.v1.ThresholdDecisionPolicy",      "threshold": "1",      "windows": {        "voting_period": "120h",        "min_execution_period": "0s"      }    },  }}
```

#### GroupMembers[​](#groupmembers-1 "Direct link to GroupMembers")
...
```
{  "members": [    {      "group_id": "1",      "member": {        "address": "cosmos1..",        "weight": "1",        "metadata": "AQ=="      }    },    {      "group_id": "1",      "member": {        "address": "cosmos1..",        "weight": "2",        "metadata": "AQ=="    }  ],  "pagination": {    "next_key": null,    "total": "2"  }}
```

#### GroupsByAdmin[​](#groupsbyadmin-1 "Direct link to GroupsByAdmin")
...
```
{  "groups": [    {      "id": "1",      "admin": "cosmos1..",      "metadata": "AQ==",      "version": "1",      "total_weight": "3"    },    {      "id": "2",      "admin": "cosmos1..",      "metadata": "AQ==",      "version": "1",      "total_weight": "3"    }  ],  "pagination": {    "next_key": null,    "total": "2"  }}
```

#### GroupPoliciesByGroup[​](#grouppoliciesbygroup-1 "Direct link to GroupPoliciesByGroup")
...
#### GroupPoliciesByAdmin[​](#grouppoliciesbyadmin-1 "Direct link to GroupPoliciesByAdmin")
...
#### Proposal[​](#proposal-3 "Direct link to Proposal")
...
#### ProposalsByGroupPolicy[​](#proposalsbygrouppolicy-1 "Direct link to ProposalsByGroupPolicy")
...
#### VoteByProposalVoter[​](#votebyproposalvoter-1 "Direct link to VoteByProposalVoter")
...
```
{  "vote": {    "proposal_id": "1",    "voter": "cosmos1..",    "choice": "CHOICE_YES",    "metadata": "AQ==",    "submitted_at": "2021-12-17T08:05:02.490164009Z"  }}
```

#### VotesByProposal[​](#votesbyproposal-1 "Direct link to VotesByProposal")
...
```
{  "votes": [    {      "proposal_id": "1",      "voter": "cosmos1..",      "option": "CHOICE_YES",      "metadata": "AQ==",      "submit_time": "2021-12-17T08:05:02.490164009Z"    }  ],  "pagination": {    "next_key": null,    "total": "1"  }}
```

#### VotesByVoter[​](#votesbyvoter-1 "Direct link to VotesByVoter")
...
```
{  "votes": [    {      "proposal_id": "1",      "voter": "cosmos1..",      "choice": "CHOICE_YES",      "metadata": "AQ==",      "submitted_at": "2021-12-17T08:05:02.490164009Z"    }  ],  "pagination": {    "next_key": null,    "total": "1"  }}
```
...
### Proposal[​](#proposal-4 "Direct link to Proposal")

Location: off-chain as json object stored on IPFS (mirrors [gov proposal](/v0.53/build/modules/gov#metadata))
...
### Vote[​](#vote-2 "Direct link to Vote")

Location: on-chain as json within 255 character limit (mirrors [gov vote](/v0.53/build/modules/gov#metadata))

```
{  "justification": "",}
```

### Group[​](#group-1 "Direct link to Group")

Location: off-chain as json object stored on IPFS

```
{  "name": "",  "description": "",  "group_website_url": "",  "group_forum_url": "",}
```

### Decision policy[​](#decision-policy-1 "Direct link to Decision policy")
