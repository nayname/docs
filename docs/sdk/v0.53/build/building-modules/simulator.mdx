...
<Note>
  * [Cosmos Blockchain Simulator](/v0.53/learn/advanced/simulation)
</Note>
...
## Simulation Package[​](#simulation-package "Direct link to Simulation Package")

The Cosmos SDK suggests organizing your simulation related code in a `x/<module>/simulation` package.

## Simulation App Module[​](#simulation-app-module "Direct link to Simulation App Module")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/3c6deab626648e47de752c33dac5d06af83e3ee3/types/module/simulation.go#L16-L27)
...
## SimsX[​](#simsx "Direct link to SimsX")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/main/testutil/simsx/runner.go#L223-L234)

These methods allow constructing randomized messages and/or proposal messages.

<Check>
  Note that modules should **not** implement both `HasWeightedOperationsX` and `HasWeightedOperationsXWithProposals`. See the runner code [here](https://github.com/cosmos/cosmos-sdk/blob/main/testutil/simsx/runner.go#L330-L339) for details
...
## Store decoders[​](#store-decoders "Direct link to Store decoders")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/main/x/bank/module.go#L181-L184)

Modules not using collections must manually build the store decoder. See the implementation [here](https://github.com/cosmos/cosmos-sdk/blob/main/x/distribution/simulation/decoder.go) from the distribution module for an example.

## Randomized genesis[​](#randomized-genesis "Direct link to Randomized genesis")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/main/types/module/simulation.go#L20)
...
## Random weighted operations[​](#random-weighted-operations "Direct link to Random weighted operations")
...
Operations on the simulation are simulated using the full [transaction cycle](/v0.53/learn/advanced/transactions) of a `ABCI` application that exposes the `BaseApp`.

### Using Simsx[​](#using-simsx "Direct link to Using Simsx")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/main/x/distribution/module.go#L196-L206)
...
## App Simulator manager[​](#app-simulator-manager "Direct link to App Simulator manager")
...
```
type CoolApp struct {...sm *module.SimulationManager}
```
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/main/simapp/app.go#L650-L660)
...
```
// SimulationManager implements the SimulationApp interfacefunc (app *SimApp) SimulationManager() *module.SimulationManager {return app.sm}
```

## Running Simulations[​](#running-simulations "Direct link to Running Simulations")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/main/testutil/simsx/runner.go#L69-L88)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/b55b9e14fb792cc8075effb373be9d26327fddea/testutil/simsx/runner.go#L151-L168)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/main/simapp/sim_test.go#L53-L65)
