...
<Note>
  `PreBlocker` is optional method module developers can implement in their module. They will be triggered before [`BeginBlock`](/v0.53/learn/advanced/baseapp#beginblock).
</Note>
