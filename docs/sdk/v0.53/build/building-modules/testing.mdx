...
Simulations uses as well a minimal application, built with [`depinject`](/docs/sdk/v0.53/build/packages/depinject):
...
<Note>
**warning**
The SDK is in the process of creating its E2E tests, as defined in [ADR-59](/docs/sdk/v0.53/build/architecture/adr-059-test-scopes). This page will eventually be updated with better examples.
</Note>

## Learn More

Learn more about testing scope in [ADR-59](/docs/sdk/v0.53/build/architecture/adr-059-test-scopes).
