...
* [Store](/docs/sdk/v0.53/build/spec/store/store) - The core Merkle store that holds the state.
* [Bech32](/docs/sdk/v0.53/build/spec/addresses/bech32) - Address format for Cosmos SDK applications.

## Modules specifications[​](#modules-specifications "Direct link to Modules specifications")

Go the [module directory](/docs/sdk/v0.53/build/modules/modules)
