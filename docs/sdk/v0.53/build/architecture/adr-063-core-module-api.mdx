...
* [ADR 033: Protobuf-based Inter-Module Communication](/v0.53/build/architecture/adr-033-protobuf-inter-module-comm) clients.
...
In the case of gogo proto and amino interfaces, the registration of these generally should happen as early as possible during initialization and in [ADR 057: App Wiring](/v0.53/build/architecture/adr-057-app-wiring-1.md), protobuf type registration happens before dependency injection (although this could alternatively be done dedicated DI providers).
...
Extension interface for CLI commands will be provided via the `cosmossdk.io/client/v2` module and its [autocli](/v0.53/build/architecture/adr-058-auto-generated-cli.md) framework.

#### Example Usage[​](#example-usage "Direct link to Example Usage")

Here is an example of setting up a hypothetical `foo` v2 module which uses the [ORM](/v0.53/build/architecture/adr-055-orm.md) for its state management and genesis.
...
* [ADR 033: Protobuf-based Inter-Module Communication](/v0.53/build/architecture/adr-033-protobuf-inter-module-comm.md)
* [ADR 057: App Wiring](/v0.53/build/architecture/adr-057-app-wiring-1.md)
* [ADR 055: ORM](/v0.53/build/architecture/adr-055-orm.md)
* [ADR 028: Public Key Addresses](/v0.53/build/architecture/adr-028-public-key-addresses.md)
