...
NFTs are more than just crypto art, which is very helpful for accruing value to the Cosmos ecosystem. As a result, Cosmos Hub should implement NFT functions and enable a unified mechanism for storing and sending the ownership representative of NFTs as discussed in [https://github.com/cosmos/cosmos-sdk/discussions/9065](https://github.com/cosmos/cosmos-sdk/discussions/9065).
...
```
service Msg {  rpc Send(MsgSend)         returns (MsgSendResponse);}message MsgSend {  string class_id = 1;  string id       = 2;  string sender   = 3;  string reveiver = 4;}message MsgSendResponse {}
```
...
* Initial discussion: [https://github.com/cosmos/cosmos-sdk/discussions/9065](https://github.com/cosmos/cosmos-sdk/discussions/9065)
* x/nft: initialize module: [https://github.com/cosmos/cosmos-sdk/pull/9174](https://github.com/cosmos/cosmos-sdk/pull/9174)
