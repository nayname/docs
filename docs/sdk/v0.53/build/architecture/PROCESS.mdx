...
4. Add an entry to the list in the [README](/v0.53/build/architecture) file.
5. Create a Pull Request to propose a new ADR.

## What is an ADR?[​](#what-is-an-adr "Direct link to What is an ADR?")
...
## ADR life cycle[​](#adr-life-cycle "Direct link to ADR life cycle")
...
### ADR status[​](#adr-status "Direct link to ADR status")
...
#### Consensus Status[​](#consensus-status "Direct link to Consensus Status")

```
DRAFT -> PROPOSED -> LAST CALL yyyy-mm-dd -> ACCEPTED | REJECTED -> SUPERSEDED by ADR-xxx                  \        |                   \       |                    v      v                     ABANDONED
```
...
## Language used in ADR[​](#language-used-in-adr "Direct link to Language used in ADR")
