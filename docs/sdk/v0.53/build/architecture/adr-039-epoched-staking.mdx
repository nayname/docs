...
* For light client efficiency, there can be a bit included in the header indicating an intra-epoch slash (ala [https://github.com/tendermint/spec/issues/199](https://github.com/tendermint/spec/issues/199)).
...
### Token lockup[​](#token-lockup "Direct link to Token lockup")
...
### Pipelining the epochs[​](#pipelining-the-epochs "Direct link to Pipelining the epochs")
...
### Parameterizing the epoch length[​](#parameterizing-the-epoch-length "Direct link to Parameterizing the epoch length")
...
### Staking messages[​](#staking-messages "Direct link to Staking messages")
...
### Slashing messages[​](#slashing-messages "Direct link to Slashing messages")
...
### Evidence Messages[​](#evidence-messages "Direct link to Evidence Messages")
