...
### `MsgTokenizeShares`[​](#msgtokenizeshares "Direct link to msgtokenizeshares")
...
### `MsgRedeemTokensforShares`[​](#msgredeemtokensforshares "Direct link to msgredeemtokensforshares")
...
### `MsgTransferTokenizeShareRecord`[​](#msgtransfertokenizesharerecord "Direct link to msgtransfertokenizesharerecord")
...
### `MsgExemptDelegation`[​](#msgexemptdelegation "Direct link to msgexemptdelegation")
