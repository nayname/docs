...
| RecoveryTxMiddleware    | This index recovers from panics. It replaces baseapp.runTx's panic recovery described in [ADR-022](/docs/sdk/v0.50/adr-022-custom-panic-handling).                                                                                                                                                                                                                                                                                                                                       |
