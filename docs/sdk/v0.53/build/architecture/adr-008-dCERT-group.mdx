...
as defined in [ADR 007](/docs/sdk/v0.50/adr-007-specialization-groups). This will include the
implementation of:
...
[Specialization Groups ADR](/docs/sdk/v0.50/adr-007-specialization-groups)
