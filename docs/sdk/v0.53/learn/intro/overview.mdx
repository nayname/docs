...
The goal of the Cosmos SDK is to allow developers to easily create custom blockchains from scratch that can natively interoperate with other blockchains. We further this modular approach by allowing developers to plug and play with different consensus engines this can range from the [CometBFT](https://github.com/cometbft/cometbft) or [Rollkit](https://rollkit.dev/).
...
What's more, the Cosmos SDK is a capabilities-based system that allows developers to better reason about the security of interactions between modules. For a deeper look at capabilities, jump to [Object-Capability Model](/v0.53/learn/advanced/ocap).
...
## What are Application-Specific Blockchains[​](#what-are-application-specific-blockchains "Direct link to What are Application-Specific Blockchains")
...
Learn more about [application-specific blockchains](/v0.53/learn/intro/why-app-specific).

## What is Modularity[​](#what-is-modularity "Direct link to What is Modularity")
...
## Why the Cosmos SDK[​](#why-the-cosmos-sdk "Direct link to Why the Cosmos SDK")
...
* The Cosmos SDK is open-source and designed to make it easy to build blockchains out of composable [modules](/v0.53/build/modules). As the ecosystem of open-source Cosmos SDK modules grows, it will become increasingly easier to build complex decentralized platforms with it.
...
## Getting started with the Cosmos SDK[​](#getting-started-with-the-cosmos-sdk "Direct link to Getting started with the Cosmos SDK")

* Learn more about the [architecture of a Cosmos SDK application](/v0.53/learn/intro/sdk-app-architecture)
