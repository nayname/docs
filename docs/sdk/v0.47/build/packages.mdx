...
* [Collections](/v0.47/build/packages/collections) - State management library
* [ORM](/v0.47/build/packages/orm) - State management library

## Automation[​](#automation "Direct link to Automation")

* [Depinject](/v0.47/build/packages/depinject) - Dependency injection framework
