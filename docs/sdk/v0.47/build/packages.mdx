...
<Check>
  For more information on SDK modules, see the [SDK Modules](/docs/sdk/v0.47/build/modules/modules) section. For more information on SDK tooling, see the [Tooling](/docs/sdk/v0.47/build/tooling) section.
</Check>
