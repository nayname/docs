...
| RecoveryTxMiddleware    | This index recovers from panics. It replaces baseapp.runTx's panic recovery described in [ADR-022](/v0.47/build/architecture/adr-022-custom-panic-handling).                                                                                                                                                                                                                                                                                                                             |
...
The middleware-based design builds upon the existing antehandlers design described in [ADR-010](/v0.47/build/architecture/adr-010-modular-antehandler). Even though the final decision of ADR-010 was to go with the "Simple Decorators" approach, the middleware design is actually very similar to the other [Decorator Pattern](/v0.47/build/architecture/adr-010-modular-antehandler#decorator-pattern) proposal, also used in [weave](https://github.com/iov-one/weave).
