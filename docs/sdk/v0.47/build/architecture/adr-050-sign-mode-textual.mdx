...
The text can contain the full range of Unicode code points, including control characters and nul. The device is responsible for deciding how to display characters it cannot render natively. See [annex 2](/v0.47/build/architecture/adr-050-sign-mode-textual-annex2) for guidance.
...
By including this hash in the SIGN\_MODE\_TEXTUAL signing payload, we keep the same level of guarantees as [SIGN\_MODE\_DIRECT](/v0.47/build/architecture/adr-020-protobuf-transaction-encoding).
...
See [annex 2](/v0.47/build/architecture/adr-050-sign-mode-textual-annex2).
...
* Some details on value renderers need to be polished, see [Annex 1](/v0.47/build/architecture/adr-050-sign-mode-textual-annex1).
...
* [Annex 1](/v0.47/build/architecture/adr-050-sign-mode-textual-annex1)
