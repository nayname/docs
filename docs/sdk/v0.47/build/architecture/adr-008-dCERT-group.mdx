...
The dCERT group is proposed to include an implementation of a `SpecializationGroup` as defined in [ADR 007](/v0.47/build/architecture/adr-007-specialization-groups). This will include the implementation of:
...
[Specialization Groups ADR](/v0.47/build/architecture/adr-007-specialization-groups)
