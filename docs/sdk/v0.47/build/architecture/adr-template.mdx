...
> Please have a look at the [PROCESS](/v0.47/build/architecture/PROCESS#adr-status) page. Use DRAFT if the ADR is in a draft stage (draft PR) or PROPOSED if it's in review.
