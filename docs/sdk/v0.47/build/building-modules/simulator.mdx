...
<Note>
  ...
  * [Cosmos Blockchain Simulator](/v0.47/learn/advanced/simulation)
</Note>
...
### Randomized parameter changes[​](#randomized-parameter-changes "Direct link to Randomized parameter changes")
...
Operations on the simulation are simulated using the full [transaction cycle](/v0.47/learn/advanced/transactions) of a `ABCI` application that exposes the `BaseApp`.
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/x/staking/simulation/operations.go#L19-L86)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/Makefile#L293-L299)
...
### Random proposal contents[​](#random-proposal-contents "Direct link to Random proposal contents")
...
## Registering simulation functions[​](#registering-simulation-functions "Direct link to Registering simulation functions")
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/x/distribution/module.go#L180-L203)
...
```
type CustomApp struct {  ...  sm *module.SimulationManager}
```
