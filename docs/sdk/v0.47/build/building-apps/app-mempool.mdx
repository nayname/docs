...
<Note>
  ...
  * [BaseApp](/v0.47/learn/advanced/baseapp)
</Note>
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/baseapp/baseapp.go#L868-L916)

This default implementation can be overridden by the application developer in favor of a custom implementation in [`app.go`](/v0.47/build/building-apps/app-go-v2):
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/baseapp/baseapp.go#L927-L942)

Like `PrepareProposal` this implementation is the default and can be modified by the application developer in [`app.go`](/v0.47/build/building-apps/app-go-v2):
...
The default SDK is a [No-op Mempool](#no-op-mempool), but it can be replaced by the application developer in [`app.go`](/v0.47/build/building-apps/app-go-v2):
