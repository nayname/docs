...
The Cosmos SDK allows much easier wiring of an `app.go` thanks to App Wiring and [`depinject`](/docs/sdk/v0.47/build/packages/depinject).
Learn more about the rationale of App Wiring in [ADR-057](/docs/sdk/v0.47/build/architecture/adr-057-app-wiring).
...
* [Modules depinject-ready](/docs/sdk/v0.47/build/building-modules/depinject)
