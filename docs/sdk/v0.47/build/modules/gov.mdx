...
This module will be used in the Cosmos Hub, the first Hub in the Cosmos network. Features that may be added in the future are described in [Future Improvements](#future-improvements).
...
Location: off-chain as json object stored on IPFS (mirrors [group proposal](/v0.47/build/modules/group#metadata))
...
Location: on-chain as json within 255 character limit (mirrors [group vote](/v0.47/build/modules/group#metadata))
