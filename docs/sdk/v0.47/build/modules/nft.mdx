...
### Class[​](#class-1 "Direct link to Class")
...
### NFTOfClassByOwner[​](#nftofclassbyowner "Direct link to NFTOfClassByOwner")
...
<Warning>
  The validation of `ClassID` and `NftID` is left to the app developer. The SDK does not provide any validation for these fields.
</Warning>
