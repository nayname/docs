...
**Note:** The authz module is different from the [auth (authentication)](/v0.47/build/modules/auth) module that is responsible for specifying the base transaction and account types.
