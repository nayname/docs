...
Under the hood the `collections.Map` will convert the key and value to bytes using the [key and value codec](/v0.47/build/packages/README.md#key-and-value-codecs). It will prepend to our bytes key the [prefix](/v0.47/build/packages/README.md#prefix) and store it in the KVStore of the module.
