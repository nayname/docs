...
<Note>
  ...
  * [Anatomy of an SDK application](/v0.47/learn/beginner/overview-app)
</Note>
...
* First, an [`encodingCodec`](/v0.47/learn/advanced/encoding) is instantiated for the application.
* Then, the `config` is retrieved and config parameters are set. This mainly involves setting the Bech32 prefixes for [addresses](/v0.47/learn/beginner/accounts#addresses).
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/types/config.go#L14-L29)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/simapp/simd/main.go)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/server/start.go#L220)
...
In practice, the [constructor of the application](/v0.47/learn/beginner/overview-app#constructor-function) is passed as the `appCreator`.
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/simapp/simd/cmd/root.go#L254-L268)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/server/start.go#L336-L348)
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/server/start.go#L350-L352)
...
To discover how to concretely run a node and interact with it, please refer to our [Running a Node, API and CLI](/v0.47/user/run-node/run-node) guide.
