...
## Ocaps in practice[​](#ocaps-in-practice "Direct link to Ocaps in practice")
...
```
type AppAccount struct {...}account := &AppAccount{    Address: pub.Address(),    Coins: sdk.Coins{sdk.NewInt64Coin("ATM", 100)},}sumValue := externalModule.ComputeSumValue(account)
```
...
[See full example on GitHub](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/simapp/app.go#L294-L318)

The following diagram shows the current dependencies between keepers.

![Keeper dependencies](/images/v0.47/learn/advanced/cosmos/cosmos-sdk/release/v0.46.x/docs/uml/svg/keeper_dependencies.svg)
