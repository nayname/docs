...
## Store Interfaces[​](#store-interfaces "Direct link to Store Interfaces")

### KVStore[​](#kvstore "Direct link to KVStore")
...
### CommitKVStore[​](#commitkvstore "Direct link to CommitKVStore")
...
### StoreDB[​](#storedb "Direct link to StoreDB")
...
### DBAdapter[​](#dbadapter "Direct link to DBAdapter")
...
### TransientStore[​](#transientstore "Direct link to TransientStore")
...
## Store Abstractions[​](#store-abstractions "Direct link to Store Abstractions")
...
### CacheWrap[​](#cachewrap "Direct link to CacheWrap")
...
### HistoryStore[​](#historystore "Direct link to HistoryStore")
...
### IndexStore[​](#indexstore "Direct link to IndexStore")
...
### Queryable[​](#queryable "Direct link to Queryable")
...
### PrefixIterator[​](#prefixiterator "Direct link to PrefixIterator")
...
### RootMultiStore[​](#rootmultistore "Direct link to RootMultiStore")
...
### GasKVStore[​](#gaskvstore "Direct link to GasKVStore")
...
## Store Migration[​](#store-migration "Direct link to Store Migration")
