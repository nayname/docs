...
Learn more about [application-specific blockchains](/v0.47/learn/intro/why-app-specific).
...
* The Cosmos SDK is open-source and designed to make it easy to build blockchains out of composable [modules](/v0.47/build/modules). As the ecosystem of open-source Cosmos SDK modules grows, it will become increasingly easier to build complex decentralized platforms with it.
...
* Learn more about the [architecture of a Cosmos SDK application](/v0.47/learn/intro/sdk-app-architecture)
