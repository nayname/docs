...
<Info>
**For dApp developers**: Instead of having users manually add networks, implement [EIP-6963](https://eips.ethereum.org/EIPS/eip-6963) for wallet discovery and the "Add Chain" functionality to prompt users to add the network, as well as the "Switch Network" prompt to switch to the network if it already exists..
</Info>
