...
const config: HardhatUserConfig = {
  ...
  networks: {
    local: {
      ...
      chainId: 262144, // Default local chain ID
      accounts: process.env.PRIVATE_KEY ? [process.env.PRIVATE_KEY] : [],
      gasPrice: 20000000000,
    },
    testnet: {
      url: "https://cevm-01-evmrpc.dev.skip.build",
      chainId: 262144, // Cosmos EVM devnet chain ID
      accounts: process.env.PRIVATE_KEY ? [process.env.PRIVATE_KEY] : [],
    }
  },
  gasReporter: {
    ...
    customChains: [
      {
        ...
        chainId: 262144, // Cosmos EVM devnet chain ID
        urls: {
          apiURL: "https://cevm-01-lcd.dev.skip.build/api",
          browserURL: "https://cevm-01-lcd.dev.skip.build"
        }
      }
    ]
  }
