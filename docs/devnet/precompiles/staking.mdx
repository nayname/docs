...
// ABI definition for the function
const precompileAbi = [
  "function delegatorDelegations(address delegatorAddress, tuple(bytes key, uint64 offset, uint64 limit, bool countTotal, bool reverse) pageRequest) view returns (tuple(tuple(address delegatorAddress, string validatorAddress, string shares) delegation, tuple(string denom, uint256 amount) balance)[] delegations, tuple(bytes nextKey, uint64 total) pageResponse)"
];
...
async function getDelegatorDelegations() {
  try {
    const result = await contract.delegatorDelegations(delegatorAddress, pagination);
    console.log("Delegations:", JSON.stringify(result.delegations, null, 2));
    console.log("Pagination Response:", result.pageResponse);
  } catch (error) {
    console.error("Error fetching delegator delegations:", error);
  }
}
...
// ABI definition for the function
const precompileAbi = [
  "function delegatorUnbondingDelegations(address delegatorAddress, tuple(bytes key, uint64 offset, uint64 limit, bool countTotal, bool reverse) pageRequest) view returns (tuple(address delegatorAddress, string validatorAddress, tuple(uint256 creationHeight, uint256 completionTime, string initialBalance, string balance)[] entries)[] unbondingDelegations, tuple(bytes nextKey, uint64 total) pageResponse)"
];
...
async function getDelegatorUnbondingDelegations() {
  try {
    const result = await contract.delegatorUnbondingDelegations(delegatorAddress, pagination);
    console.log("Unbonding Delegations:", JSON.stringify(result.unbondingDelegations, null, 2));
    console.log("Pagination Response:", result.pageResponse);
  } catch (error) {
    console.error("Error fetching delegator unbonding delegations:", error);
  }
}
...
// ABI definition for the function
const precompileAbi = [
  "function delegatorValidators(address delegatorAddress, tuple(bytes key, uint64 offset, uint64 limit, bool countTotal, bool reverse) pageRequest) view returns (tuple(string operatorAddress, string consensusPubkey, bool jailed, uint32 status, uint256 tokens, string delegatorShares, tuple(string moniker, string identity, string website, string securityContact, string details) description, int64 unbondingHeight, uint256 unbondingTime, tuple(tuple(string rate, string maxRate, string maxChangeRate) commissionRates, uint256 updateTime) commission, uint256 minSelfDelegation)[] validators, tuple(bytes nextKey, uint64 total) pageResponse)"
];
...
async function getDelegatorValidators() {
  try {
    const result = await contract.delegatorValidators(delegatorAddress, pagination);
    console.log("Delegator Validators:", JSON.stringify(result.validators, null, 2));
    console.log("Pagination Response:", result.pageResponse);
  } catch (error) {
...
// ABI definition for the function
const precompileAbi = [
  "function delegatorValidator(address delegatorAddress, string memory validatorAddress) view returns (tuple(string operatorAddress, string consensusPubkey, bool jailed, uint32 status, uint256 tokens, string delegatorShares, tuple(string moniker, string identity, string website, string securityContact, string details) description, int64 unbondingHeight, uint256 unbondingTime, tuple(tuple(string rate, string maxRate, string maxChangeRate) commissionRates, uint256 updateTime) commission, uint256 minSelfDelegation) validator)"
];
...
async function getDelegatorValidator() {
  try {
    const validator = await contract.delegatorValidator(delegatorAddress, validatorAddress);
    console.log("Delegator Validator:", JSON.stringify(validator, null, 2));
  } catch (error) {
    console.error("Error fetching delegator validator:", error);
  }
}
...
async function getPool() {
  try {
    ...
    console.log("Staking Pool:", JSON.stringify(pool, null, 2));
  } catch (error) {
...
async function getParams() {
  try {
    ...
    console.log("Staking Parameters:", JSON.stringify(params, null, 2));
  } catch (error) {
