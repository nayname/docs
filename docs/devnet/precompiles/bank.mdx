...
**Description**: Queries all native token balances for a specific account address. Returns an array of Balance structures containing the ERC20 contract address and amount for each token held by the account.
