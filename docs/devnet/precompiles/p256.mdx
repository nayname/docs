...
# The `data` field must be constructed by ABI-encoding the desired
# function selector and parameters. Refer to the Solidity interface
# for function signatures and data types.
curl -X POST --data '{
    "jsonrpc": "2.0",
    "method": "eth_call",
    "params": [
