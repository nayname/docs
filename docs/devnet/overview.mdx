...
| **Cosmos Chain ID** | `4231` | Identifier when signing Cosmos transactions |
| **EVM Chain ID** | `0x1087` | Numeric network identifier for EVM tools [Hexadecimal equivalent of the Cosmos Chain ID] |
