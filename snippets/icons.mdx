...
export const EthereumIcon = ({ size = 24, color = "currentColor", className = "" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M12 1L11.8125 1.66406V15.3438L12 15.5313L18.375 12L12 1Z" fill={color} opacity="0.6"/>
    <path d="M12 1L5.625 12L12 15.5313V8.46875V1Z" fill={color}/>
    <path d="M12 16.6563L11.8906 16.7812V22.2188L12 22.5L18.375 13.125L12 16.6563Z" fill={color} opacity="0.6"/>
    <path d="M12 22.5V16.6563L5.625 13.125L12 22.5Z" fill={color}/>
    <path d="M12 15.5313L18.375 12L12 8.46875V15.5313Z" fill={color} opacity="0.2"/>
    <path d="M5.625 12L12 15.5313V8.46875L5.625 12Z" fill={color} opacity="0.6"/>
  </svg>
)
