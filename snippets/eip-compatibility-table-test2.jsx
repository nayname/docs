export default function EIPCompatibilityTableTest2({ sheetTab } = {}) {
  ...
  const loadGoogleSheetData = async () => {
    try {
      ...
      // Convert to our format - skip first row (header row from sheet)
  ...
  return (
    <>
      ...
      {tooltip.show && (
        <div
          className="fixed z-50 px-3 py-2 text-sm text-white bg-gray-900 rounded-md shadow-lg max-w-xs break-words"
          style={{
            left: tooltip.x,
            top: tooltip.y,
      ...
      <div className="bg-white dark:bg-black relative p-6 border border-gray-200 dark:border-gray-800 rounded-lg" 
           style={{ width: '105%' }}>
      {/* Search and Filters */}
      <div className="pb-4 border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400">
            Showing {filteredData.length} of {eipData.length} EIPs (Test 2: Container Strategy)
      ...
      <div className="sticky top-0 z-30 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 mt-4">
        <div className="grid gap-0" style={{gridTemplateColumns: '85px 120px 130px 130px 220px 150px'}}>
          <div 
      ...
      <div className="overflow-auto shadow-[0_0_0_1px_rgba(156,163,175,0.3)] dark:shadow-[0_0_0_1px_rgba(75,85,99,0.5)] rounded-lg mt-4" style={{ maxHeight: 'calc(100vh - 240px)' }}>
        <div className="divide-y divide-gray-200 dark:divide-gray-800">
          {filteredData.map((eip, index) => (
            <div key={eip.eip} className={`grid gap-0 ${index % 2 === 0 ? 'bg-white dark:bg-black' : 'bg-gray-50 dark:bg-gray-900'} hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors`}
                 style={{gridTemplateColumns: '85px 120px 130px 130px 220px 150px'}}>
              ...
              <div className="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                <div 
                    ...
                    onMouseEnter={(e) => handleMouseEnter(e, eip.title)}
              ...
              <div className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">
                  {eip.critical ? 'Yes' : '-'}
              </div>
              <div className="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                <div 
                    ...
                    onMouseEnter={(e) => handleMouseEnter(e, eip.cosmos)}
                    onMouseLeave={handleMouseLeave}
                >
                    {eip.cosmos}
                </div>
              ...
              <div className="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                <div 
                    ...
                    onMouseEnter={(e) => handleMouseEnter(e, eip.note + (eip.issue ? ` (Issue #${eip.issue})` : ''))}
                    onMouseLeave={handleMouseLeave}
                >
                    {eip.note}
                    {eip.issue && (
