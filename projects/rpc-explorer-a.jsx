      ...
      <div className="sticky top-0 z-20 bg-zinc-950 dark:bg-zinc-950 border-b border-zinc-800 dark:border-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="px-6 pb-4">
            <div className="bg-zinc-900 dark:bg-zinc-900/50 rounded-lg p-4 border border-zinc-800 dark:border-white/10">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 max-w-md">
                  <input
                    ...
                    className={`w-full px-3 py-2 bg-zinc-800 dark:bg-zinc-800/50 text-white rounded-lg border ${
                      isValidEndpoint
                        ? 'border-green-500'
                        : isInvalidEndpoint
                        ? 'border-red-500'
              ...
              {isValidEndpoint && (
                <p className="mt-2 text-xs text-blue-400">
                  Interactive mode active - Click "Execute" on any method to test
                </p>
              )}
              <p className="mt-1 text-xs text-zinc-500">
                Enter an RPC endpoint to enable interactive testing. Some endpoints may require CORS configuration.
              </p>
            </div>
          </div>
